...
## Child Docs Index
- [DAO/](DAO/agents.md)
- [Data Room/](Data Room/agents.md)
- [Github/](Github/agents.md)
- [Partners/](Partners/agents.md)
- [_wnoded_disabled/](_wnoded_disabled/agents.md)
- [ai/](ai/agents.md)
- [apps/](apps/agents.md)
- [backups/](backups/agents.md)
- [cmd/](cmd/agents.md)
- [company docs/](company docs/agents.md)
- [docs/](docs/agents.md)
- [ee_branding/](ee_branding/agents.md)
- [favicon_set/](favicon_set/agents.md)
- [integrations/](integrations/agents.md)
- [logo_package/](logo_package/agents.md)
- [node-operator/](node-operator/agents.md)
- [nodld/](nodld/agents.md)
- [rebrand_temp/](rebrand_temp/agents.md)
- [relics/](relics/agents.md)
- [runbooks/](runbooks/agents.md)
- [salvage/](salvage/agents.md)
- [scratch/](scratch/agents.md)
- [scripts/](scripts/agents.md)
- [services/](services/agents.md)
- [temp/](temp/agents.md)
- [web/](web/agents.md)
- [wenode-hardhat/](wenode-hardhat/agents.md)
...
- `.git_token`
- `.gitignore`
- `.~lock.Project plan.ods#`
- `.~lock.monday 23rd.odt#`
- `CONTRIBUTING.md`
- `DEPLOY_NOTES.md`
- `LICENSE`
- `OFFICIAL_TOKEN_ADDRESSES.md`
- `PROTOCOL.md`
- `README.md`
- `TODO.md`
- `Wnode Contract.txt`
...
- `callback_output.txt`
- `cmd_nodlr_backend_proxy_trace.md`
- `command.pid`
- `command_cookies.txt`
- `cookies.txt`
- `create_session.py`
...
- `csrf.json`
- `curl_stderr.txt`
- `database_entry_example.sql`
- `del.pdf`
- `del1.pdf`
- `del10.pdf`
- `del3.pdf`
- `del4.pdf`
- `deploy_health_check.md`
- `deploy_restart_summary.md`
- `destructive_fs_corruption.json`
- `destructive_mutex_starvation.json`
- `destructive_synthetic_wuid_attack.json`
- `destructive_token_forgery.json`
- `diag.sh`
- `diagnostic - delete.pdf`
- `diagnostic - delete.pdf.odt`
- `diagnostic.sh`
- `docker-compose.yml`
- `docs_index_batch1.json`
- `dom_dump.html`
- `extreme_founder_invite_stress.json`
- `fleetmap_empty_branch_visual_fix_summary.md`
- `founder_invite.json`
- `founder_invite_stress.json`
- `founder_signup_race.json`
- `founder_signup_result.json`
- `founder_signup_stress.json`
- `founder_token_fuzzing.json`
- `founder_token_security.json`
...
- `imap_fetch.py`
- `integrations_api.md`
- `integrations_seed_data.md`
- `integrations_struct.md`
- `integrations_ui_phase4.md`
- `invite_registry_saturation.json`
- `large-test.wasm`
- `mesh.pid`
- `mesh_account_me_cookie_fix_summary.md`
- `mesh_account_me_trace.md`
- `mesh_all_next_directories.md`
- `mesh_api_proxy_cookie_fix_summary.md`
- `mesh_auth_repair_summary.md`
- `mesh_backend_proxy_fix_summary.md`
- `mesh_backend_proxy_trace.md`
- `mesh_backend_root_cause.md`
- `mesh_build_origin_report.md`
- `mesh_config_comparison.md`
- `mesh_console_to_code_correlation.md`
- `mesh_cookie_extraction_fix_summary.md`
- `mesh_cookie_final_fix.md`
- `mesh_cookie_fix_validation.md`
- `mesh_cookie_forwarding_fix_summary.md`
- `mesh_cookies.txt`
- `mesh_file_consistency_report.md`
- `mesh_fleetmap_api_trace.md`
- `mesh_fleetmap_break_root_cause.md`
- `mesh_fleetmap_canonicalization_summary.md`
- `mesh_fleetmap_cmd_clone_summary.md`
- `mesh_fleetmap_data_path.md`
- `mesh_fleetmap_data_shape_comparison.md`
- `mesh_fleetmap_data_source_trace.md`
- `mesh_fleetmap_error_sanitization_summary.md`
- `mesh_fleetmap_exact_break.md`
- `mesh_fleetmap_fake_sources_report.md`
- `mesh_fleetmap_instrumentation_summary.md`
- `mesh_fleetmap_literal_diff.md`
- `mesh_fleetmap_mesh_wiring_summary.md`
- `mesh_fleetmap_reinstall_summary.md`
- `mesh_fleetmap_removal_report.md`
- `mesh_fleetmap_render_conditions.md`
- `mesh_fleetmap_render_path.md`
- `mesh_fleetmap_visibility_fix_summary.md`
- `mesh_live_verification.md`
- `mesh_login_diagnostic_report.md`
- `mesh_login_fix_summary.md`
- `mesh_login_root_cause.md`
- `mesh_login_stress_results.json`
- `mesh_next_trace.md`
- `mesh_proxy_and_edge_report.md`
- `mesh_real_source_path.md`
- `mesh_realignment_status.md`
- `mesh_rebuild_step1.md`
- `mesh_rebuild_step2.md`
- `mesh_restart_summary.md`
- `mesh_runtime_origin.md`
- `mesh_safe_mode_status.md`
- `mesh_session_forwarding_repair_summary.md`
- `mesh_vs_cmd_nodlr_backend_diff.md`
- `mesh_vs_cmd_nodlr_fleetmap_break_diff.md`
- `mesh_vs_cmd_nodlr_fleetmap_diff.md`
- `mixed_results.json`
- `monday 23rd.odt`
- `monday 23rd.pdf`
- `next.config.mjs`
...
- `package-lock.json`
- `package.json`
- `papermark_app-sidebar.tsx`
- `papermark_app_middleware.ts`
- `papermark_auth.ts`
- `papermark_branding.tsx`
- `papermark_branding_api.ts`
- `papermark_datarooms_id_index.tsx`
- `papermark_datarooms_index.tsx`
- `papermark_env`
- `papermark_globals.css`
- `papermark_globals_fresh.css`
- `papermark_layout.tsx`
- `papermark_layout_fresh.tsx`
- `papermark_login_page-client.tsx`
- `papermark_middleware.ts`
- `papermark_nav-dataroom.tsx`
- `papermark_next.config.mjs`
- `papermark_settings_billing.tsx`
- `papermark_settings_domains.tsx`
- `papermark_settings_people.tsx`
- `papermark_tailwind.config.js`
- `papermark_upgrade-plan-modal-old.tsx`
- `papermark_upgrade-plan-modal.tsx`
- `papermark_use-billing.ts`
- `peer.key`
- `phase10_governance_surfaces.json`
- `phase10_partner_destructive.json`
- `phase10_partner_invite_flow.json`
- `phase10_partner_slot_integrity.json`
- `phase10_permissions.json`
- `phase10_sot_integrity.json`
- `phase10_ui_tests.json`
- `pnpm-workspace.yaml`
- `rewrite_auth.py`
- `route_views-dataroom.ts`
- `route_views.ts`
- `scratch_create_help.js`
- `send-verification-request.ts`
- `server_git_state.md`
- `slot_corruption_attack.json`
- `slot_integrity.json`
- `snapshot.json`
- `sot_final.json`
- `sot_phase9_final.json`
- `stub.ts`
- `test-all.js`
- `test-login.js`
- `test-mesh.js`
...
# WNODE RULESET (ARCHITECTURAL CONSTITUTION)

## 1. System-Wide Invariants
- Preserve Portal Isolation.
- Preserve Sovereign Compute Boundaries.
- Preserve Session Integrity.
- Preserve Domain Routing Contracts.
- Preserve nodld Handler Contracts.
- Preserve Next.js Proxy Contracts.
- Preserve Build Determinism.

## 2. Protected Zone: dr.wnode.one
The directory, domain, deployment, database, and all associated assets belonging to `dr.wnode.one` are STRICTLY PROTECTED.
AG MUST NOT modify, delete, rename, move, or touch any file or configuration belonging to dr.wnode.one unless the user explicitly instructs:
"AG — modify dr.wnode.one".
This rule overrides all other rules.

## 3. Directories AG Must Never Modify
- apps/web/public
- .next
- node_modules
- dist
...
## 4. Directories AG May Modify Only With Explicit Permission
- nodld/internal/api
- apps/*/app/api
- apps/*/middleware.ts
- apps/*/next.config.js
...
1. Identity resolution middleware is IMMUTABLE.
   - resolveIdentity, requireAccess, requireLevel, and all related helpers
     may NEVER be modified, refactored, optimized, or harmonized
     without explicit human approval.

2. Authentication routes are IMMUTABLE.
   - /api/v1/auth/login
   - /api/v1/auth/magic-link
   - /api/v1/auth/verify
   - /api/account/me
   These routes must NEVER be removed, renamed, wrapped, or placed behind middleware.

3. JWT parsing logic is IMMUTABLE.
   - No changes to signing method, claim names, or validation flow
     without explicit human approval.

4. Portal auth behavior is IMMUTABLE.
   - 3001, 3002, and 3003 must ALWAYS use the same token keys:
       nodl_jwt
       nodl_user_id
   - All portals must ALWAYS forward Authorization: Bearer <token>
     to Nodld for identity resolution.
...
- CMD must never import NODLR or MESH code.

NODLR:
- NODLR must only call NODLR backend routes.
- NODLR must never import CMD or MESH code.

MESH:
- MESH must only call MESH backend routes.
- MESH must never import CMD or NODLR code.

WEB:
- WEB must remain static/marketing only.
- WEB must not contain business logic.

## 7. nodld Backend Rules
- Do not modify handler signatures.
- Do not modify nodld routing structure.
- Do not modify nodld session logic.
- Do not modify nodld error contracts.
- Do not modify nodld internal folder layout.

## 8. Next.js Rules
- Do not rename app routes.
- Do not modify middleware without permission.
- Do not modify next.config.js without permission.
- Do not modify API route folder names.

## 9. Code Editing Rules
- Minimal Diff Rule: AG must change as little as possible.
- Locality Rule: AG must only edit files directly related to the task.
- No Cross-Portal Edits.
- No Deletions Without Permission.
- No File Moves Without Permission.
- No Renames Without Permission.

## 10. Documentation Rules
- Update agents.md after every edit.
- Preserve parent/child links.
- Preserve file lists.
- Preserve folder purpose sections.
