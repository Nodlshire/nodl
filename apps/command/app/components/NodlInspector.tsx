        ...
        >
            {loading ? (
                <div className="h-64 flex flex-col items-center justify-center gap-4">
                    ...
                    <span className="text-[10px] text-white/40 uppercase tracking-widest font-bold">Querying Mesh Registry...</span>
                </div>
            ) : error ? (
                ...
                <div className="space-y-10">
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center justify-between">
                            <span className="text-[10px] text-white/40 uppercase tracking-widest font-bold">Operational Status</span>
                            <div className="flex items-center gap-2">
                                ...
                                <span className={`text-[11px] uppercase font-bold tracking-widest ${node.status === 'active' || node.status === 'online' ? 'text-[#22D3EE]' : 'text-white/40'}`}>
                                    {node.status || 'OFFLINE'}
                                </span>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-3">
                            <div className="bg-white/[0.02] border border-wnode-border-separator p-4 rounded-[5px]">
                                <span className="block text-[9px] text-white/40 uppercase tracking-tighter mb-1">Compute Tier</span>
                                <span className="text-[13px] text-white font-mono">{node.tier || 'Standard'}</span>
                            </div>
                            <div className="bg-white/[0.02] border border-wnode-border-separator p-4 rounded-[5px]">
                                <span className="block text-[9px] text-white/40 uppercase tracking-tighter mb-1">Uptime Score</span>
                    ...
                    {/* Hardware Profile */}
                    <section className="space-y-4">
                        <h3 className="text-[11px] text-white/60 uppercase tracking-widest border-b border-wnode-border-separator pb-2">Hardware Blueprint</h3>
                        <div className="space-y-3">
                            <div className="flex items-center justify-between group">
                                <div className="flex items-center gap-3">
                                    <Cpu className="w-4 h-4 text-[#22D3EE] opacity-40" />
                                    <span className="text-[11px] text-white/40 uppercase tracking-tighter">Processor Architecture</span>
                                </div>
                            ...
                            <div className="flex items-center justify-between group">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[11px] text-white/40 uppercase tracking-tighter">CPU Capacity</span>
                                </div>
                            ...
                            <div className="flex items-center justify-between group">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[11px] text-white/40 uppercase tracking-tighter">System Memory</span>
                                </div>
                    ...
                    {/* Network Metadata */}
                    <section className="space-y-4">
                        <h3 className="text-[11px] text-white/60 uppercase tracking-widest border-b border-wnode-border-separator pb-2">Network Metadata</h3>
                        <div className="space-y-3">
                            <div className="flex items-center justify-between group">
                                <span className="text-[11px] text-white/40 uppercase tracking-tighter">Operator Identity</span>
                            ...
                            <div className="flex items-center justify-between group">
                                <span className="text-[11px] text-white/40 uppercase tracking-tighter">Region / Geo</span>
                                <span className="text-[12px] text-white font-mono">{node.region || 'Unknown'}</span>
                            </div>
                            <div className="flex items-center justify-between group">
                                <span className="text-[11px] text-white/40 uppercase tracking-tighter">Protocol Version</span>
                                <span className="text-[12px] text-white font-mono">v{node.version || '1.2.x'}</span>
                            </div>
                            <div className="flex items-center justify-between group">
                                <span className="text-[11px] text-white/40 uppercase tracking-tighter">Last Heartbeat</span>
                                <div className="flex flex-col items-end">
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-2">
                            ...
                            <h4 className="text-[12px] font-normal text-white/80 uppercase tracking-widest">Intelligence Trace</h4>
                        </div>
                        <div className="bg-black/50 border border-wnode-border-neutral rounded-[5px] p-5 font-mono text-[11px] leading-relaxed space-y-2 max-h-[220px] overflow-y-auto custom-scrollbar shadow-inner relative">
                            ...
                            <p className="text-white/40/50 italic">[{new Date().toISOString()}] No active compute jobs assigned.</p>
