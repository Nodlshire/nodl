...
export default function SlideOutHost({ isOpen, onClose, title, data }: SlideOutHostProps) {
  ...
  return (
    ...
    >
      <div className="h-full flex flex-col items-center justify-center border border-dashed border-wnode-border-neutral rounded-[5px] p-10 space-y-8 bg-black/20">
        {isCrm && data ? (
            <div className="w-full max-w-sm space-y-8">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-[10px] text-white/40 uppercase tracking-[0.2em] mt-1 font-bold">Infrastructure Manager</p>
                    </div>
                </div>

                <div className="space-y-4">
                    <div className="p-4 bg-white/[0.03] border border-wnode-border-neutral rounded-[5px] space-y-2">
            ...
            <span className="text-[11px] text-white/40 uppercase tracking-widest text-center">
