        ...
        <main className="flex-1 p-8 overflow-y-auto pb-24 font-sans">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white/[0.02] border border-wnode-border-neutral p-12 rounded-[5px]">
                    <h1 className="text-3xl font-bold text-white mb-4 uppercase tracking-tighter">Admin Network Pricing</h1>
                    <p className="text-white/60 text-sm leading-relaxed mb-12 max-w-2xl">
                        This page provides an overview of the Admin Network Pricing functionality within the Command portal.
                    </p>
                    ...
                    <div className="space-y-16">
                        <section>
                            ...
                            <p className="text-white/60 text-[13px] leading-relaxed">
                                The Admin Network Pricing page is designed to monitor and manage relevant system metrics and configurations.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <Image src="/help/screenshots/admin-network-pricing-overview.png" alt="admin-network-pricing overview" width={800} height={400} className="rounded border border-wnode-border-neutral shadow-xl mb-4 w-full h-auto object-cover" />
                        </section>
