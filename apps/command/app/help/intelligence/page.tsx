                ...
                <div className="bg-white/[0.02] border border-white/10 p-12 rounded-[5px]">
                    ...
                    <div className="space-y-16">
                        ...
                        <section>
                            ...
                            <Image src="/help/screenshots/intelligence-overview.png" alt="intelligence overview" width={800} height={400} className="rounded border border-white/20 shadow-xl mb-4 w-full h-auto object-cover" />
                        </section>
