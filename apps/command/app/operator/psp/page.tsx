                ...
                <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/10 backdrop-blur-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div className="space-y-1">
                        ...
                        <div className="flex gap-4 text-xs font-mono text-white/60 pt-1">
                            <span>Tax ID: <strong className="text-white">{jurisdiction?.taxId}</strong></span>
                            <span>VAT: <strong className="text-white">{jurisdiction?.vatNumber}</strong></span>
                            <span>Bank Code: <strong className="text-white">{jurisdiction?.bankRoutingCode}</strong></span>
                        </div>
                    </div>
