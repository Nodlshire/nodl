            ...
            <main className="p-8 pt-24 w-full flex flex-col space-y-8 overflow-y-auto pb-24 focus:outline-none">
                ...
                <div className="flex items-center justify-between gap-4 bg-white/5 border border-wnode-border-neutral p-4 rounded-[6px] w-full">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-[#22D3EE]/5 border border-[#22D3EE]/20 rounded-full">
                            <div className="w-1.5 h-1.5 rounded-full bg-[#22D3EE] shadow-[0_0_8px_#22D3EE]" />
                            <span className="text-[10px] text-[#22D3EE] font-bold uppercase tracking-widest">Global View</span>
                        </div>
                    </div>
