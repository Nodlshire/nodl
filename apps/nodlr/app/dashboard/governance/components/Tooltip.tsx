...
export default function Tooltip({ children, text, direction = 'up' }: TooltipProps) {
  ...
  return (
    ...
    >
      {children}
      {show && (
        <div className={`absolute left-0 mb-2 w-max max-w-full bg-slate-900 text-slate-200 text-[11px] px-3 py-2 rounded-[4px] shadow-2xl z-[110] whitespace-normal text-left border border-white/10 backdrop-blur-md animate-in fade-in zoom-in duration-150 ${
