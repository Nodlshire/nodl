        ...
        <>
            ...
            <div className="my-12 p-8 bg-slate-900/50 rounded-xl border border-slate-800">
                <svg viewBox="0 0 800 200" className="w-full drop-shadow-2xl font-sans text-xs">
                    ...
                    <text x="400" y="105" fill="#cbd5e1" textAnchor="middle">2. cargo build --target linux-amd64</text>

                    <line x1="600" y1="150" x2="210" y2="150" stroke="#10b981" strokeWidth="2" markerEnd="url(#seqArrowDev)" />
                    <text x="400" y="145" fill="#10b981" textAnchor="middle">3. validate.native-go generated (850kb)</text>
                </svg>
            </div>
...
pub extern "C" fn calculate_shard(ptr: *const u8, len: usize) -> *mut u8 {
    ...
    // BAD: reqwest::get("https://api.price.com") // Will instantly panic in SECCOMP Sandbox
    ...
    res_ptr
            ...
            <ul>
                <li><strong>Network Bound Failures:</strong> Attempting to import networking libraries into your Go Native Go target will either fail to compile, or compile but instantly panic at runtime because SECCOMP Sandbox stubs all host-network bindings to throw <code>ErrNoSys</code>. </li>
  ...
  "job_id": "job_9x8c7v"
            ...
            <Callout type="warning" title="Anti-Pattern: Bloated Native Go">
                Do not compile massive binaries. If your `.native-go` file is 30MB, Node Operators will experience massive cold-start latency when downloading your substrate upgrade. Strip symbols and optimize for size.
            </Callout>
