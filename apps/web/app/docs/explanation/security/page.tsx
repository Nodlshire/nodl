...
export default function SecurityModel() {
    return (
        <>
            ...
            <p className="text-slate-300 leading-relaxed mb-6">
                <strong>The Rationale:</strong> The Wnode security model strips trust from the operator entirely. We achieve this through cryptographic ingress envelopes (HMAC + Nonces), deterministic Go Sandbox execution sandboxing, and Quorum Reduction.
            </p>
            ...
            <div className="my-12 p-8 bg-slate-900/50 rounded-xl border border-slate-800 flex items-center justify-center">
                <svg viewBox="0 0 800 350" className="w-full drop-shadow-2xl font-sans">
                    ...
                    <text x="400" y="135" fill="#8b5cf6" fontSize="12" fontWeight="bold" textAnchor="middle">Go Sandbox Sandbox</text>
    ...
    return nil
            ...
            <CodeBlock language="go" title="internal/node/wazero_security.go (Go Sandbox Sandbox Constraints)">{`// Wnode strict Go Sandbox constraints
func createSecureConfig() Go Sandbox.ModuleConfig {
    return Go Sandbox.NewModuleConfig().
        // No filesystem access
        WithFS(Go Sandbox.NewEmptyFS()).
