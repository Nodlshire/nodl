        ...
        <>
            ...
            <div className="my-12 p-8 bg-slate-900/50 rounded-xl border border-slate-800 flex items-center justify-center">
                <svg viewBox="0 0 800 350" className="w-full drop-shadow-2xl font-sans">
                    ...
                    <text x="560" y="95" fill="#94a3b8" fontSize="12" textAnchor="start">- TS SDK / Native Go concrete implementations</text>
...
func (h *{{.StructName}}) Limits() ResourceBounds {
    ...
    return format.Source(buf.Bytes())
            ...
            <ul>
                <li><strong>AST Parsing Failure:</strong> If the <code>spec.yaml</code> contains invalid types (e.g. passing a string to a boolean field), <code>intgen</code> fails immediately with a strict line-number error. Code generation is aborted, preventing malformed concrete implementations from polluting the workspace.</li>
