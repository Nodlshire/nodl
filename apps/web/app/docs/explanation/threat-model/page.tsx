...
func CalculateQuorum(results []ShardResult, requiredThreshold int) (string, error) {
    ...
    return "", errors.New("quorum failed: severe network divergence")
            ...
            <ul>
                <li><strong>Vector: Malicious Execution Sandbox Escape.</strong> An attacker crafts a Native Go payload designed to exploit Go Sandbox and gain root on the Operator machine. <br/><strong>Mitigation:</strong> Go Sandbox is written in pure Go without CGO. There are no buffer overflows or memory unsafety issues common in C/C++ runtimes. Host system access is explicitly zeroed out at initialization.</li>
  ...
  "action_taken": "shard_reassigned"
            ...
            <p className="text-slate-300 leading-relaxed mb-6">
                The Threat Model touches the ingress API (DDoS protection), the DAG Router (Sybil protection), the Node Daemon (Cgroups), and the Execution Engine (Go Sandbox sandboxing).
            </p>
