                    ...
                    <div className="space-y-6 text-slate-300">
                        ...
                        <div>
                            ...
                            <div className="bg-slate-900 border border-slate-800 p-4 rounded-lg mt-2">
                                <p className="mb-2 mb-6 leading-relaxed"><strong className="text-blue-400">Reads:</strong> <span className={integrationData.architecture?.read_write_flows?.reads === 'PENDING VERIFICATION' ? 'text-yellow-400/80' : ''}>{integrationData.architecture?.read_write_flows?.reads}</span></p>
                                <p className="text-slate-300 leading-relaxed mb-6"><strong className="text-purple-400">Writes:</strong> <span className={integrationData.architecture?.read_write_flows?.writes === 'PENDING VERIFICATION' ? 'text-yellow-400/80' : ''}>{integrationData.architecture?.read_write_flows?.writes}</span></p>
                            </div>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
