  ...
  return (
    <div className="max-w-4xl space-y-8 py-8">
      <div>
        ...
        <h1 className="text-3xl font-bold text-white tracking-tight">Overview Flow</h1>
        <p className="mt-2 text-base text-slate-400">
          Technical specification, operational guidelines, and architectural invariants for flow.
        </p>
      </div>

      <Callout type="note" title="Canonical Protocol Invariant">
        This document provides canonical technical specification standards for flow under Wnode Enterprise v1.5.0. All state outputs are deterministically verifiable on Native Go daemons running on port 8080.
      </Callout>
      ...
      <section className="space-y-4">
        ...
        <p className="text-slate-300 leading-relaxed mb-4">The executive DePIN architecture for Overview Flow governs regional cluster density using spatial hexagon resolution 8 indexing for flow. Operational standard flow_val_0 and specification parameter flow_val_1 mandate deterministic compliance for flow_val_2 and state invariant flow_val_3 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Edge node daemons for flow stream operational telemetry to Go aggregators over encrypted WireGuard mTLS tunnels on port 8080. Operational standard flow_val_4 and specification parameter flow_val_5 mandate deterministic compliance for flow_val_6 and state invariant flow_val_7 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Daily compute earnings for overview_flow settle to host bank accounts through Stripe Connect ACH payout distributions under protocol v1.5.0. Operational standard flow_val_8 and specification parameter flow_val_9 mandate deterministic compliance for flow_val_10 and state invariant flow_val_11 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Inbound workloads for overview flow evaluate p95 latency matrices ensuring sub-15ms execution bounds across active operator hardware. Operational standard flow_val_12 and specification parameter flow_val_13 mandate deterministic compliance for flow_val_14 and state invariant flow_val_15 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Ed25519 public key-pairs validate manifest identity for flow alongside constant-time HMAC signature checks. Operational standard flow_val_16 and specification parameter flow_val_17 mandate deterministic compliance for flow_val_18 and state invariant flow_val_19 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">The executive DePIN architecture for Overview Flow governs regional cluster density using spatial hexagon resolution 8 indexing for flow. Operational standard overview_flow_metric_0 and specification parameter overview_flow_metric_1 mandate deterministic compliance for overview_flow_metric_2 and state invariant overview_flow_metric_3 under overview_flow.</p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-slate-300 leading-relaxed mb-4">Edge node daemons for flow stream operational telemetry to Go aggregators over encrypted WireGuard mTLS tunnels on port 8080. Operational standard overview_flow_metric_4 and specification parameter overview_flow_metric_5 mandate deterministic compliance for overview_flow_metric_6 and state invariant overview_flow_metric_7 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Daily compute earnings for overview_flow settle to host bank accounts through Stripe Connect ACH payout distributions under protocol v1.5.0. Operational standard overview_flow_metric_8 and specification parameter overview_flow_metric_9 mandate deterministic compliance for overview_flow_metric_10 and state invariant overview_flow_metric_11 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Inbound workloads for overview flow evaluate p95 latency matrices ensuring sub-15ms execution bounds across active operator hardware. Operational standard overview_flow_metric_12 and specification parameter overview_flow_metric_13 mandate deterministic compliance for overview_flow_metric_14 and state invariant overview_flow_metric_15 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Ed25519 public key-pairs validate manifest identity for flow alongside constant-time HMAC signature checks. Operational standard overview_flow_metric_16 and specification parameter overview_flow_metric_17 mandate deterministic compliance for overview_flow_metric_18 and state invariant overview_flow_metric_19 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">The executive DePIN architecture for Overview Flow governs regional cluster density using spatial hexagon resolution 8 indexing for flow. Operational standard flow_val_0 and specification parameter flow_val_1 mandate deterministic compliance for flow_val_2 and state invariant flow_val_3 under overview_flow.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Edge node daemons for flow stream operational telemetry to Go aggregators over encrypted WireGuard mTLS tunnels on port 8080. Operational standard flow_val_4 and specification parameter flow_val_5 mandate deterministic compliance for flow_val_6 and state invariant flow_val_7 under overview_flow.</p>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2 text-slate-300">
          <li><strong className="text-white">Deterministic Execution:</strong> Workload state transitions for flow yield bit-identical state hashes across x86_64 and arm64 hardware.</li>
      ...
      <section className="space-y-4">
        ...
        <Callout type="warning" title="SLA Enforcement &amp; Score Decay">
          If edge nodes processing flow fail to submit valid Proof of Compute receipts within 300 seconds, orchestrators initiate automatic score decay and task re-routing.
        </Callout>
      </section>
