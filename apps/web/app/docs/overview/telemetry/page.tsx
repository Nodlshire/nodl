  ...
  return (
    <div className="max-w-4xl space-y-8 py-8">
      <div>
        ...
        <h1 className="text-3xl font-bold text-white tracking-tight">Overview Telemetry</h1>
      ...
      <section className="space-y-4">
        ...
        <p className="text-slate-300 leading-relaxed mb-4">The executive DePIN architecture for Overview Telemetry governs regional cluster density using spatial hexagon resolution 8 indexing for telemetry. Operational standard telemetry_val_0 and specification parameter telemetry_val_1 mandate deterministic compliance for telemetry_val_2 and state invariant telemetry_val_3 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Edge node daemons for telemetry stream operational telemetry to Go aggregators over encrypted WireGuard mTLS tunnels on port 8080. Operational standard telemetry_val_4 and specification parameter telemetry_val_5 mandate deterministic compliance for telemetry_val_6 and state invariant telemetry_val_7 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Daily compute earnings for overview_telemetry settle to host bank accounts through Stripe Connect ACH payout distributions under protocol v1.5.0. Operational standard telemetry_val_8 and specification parameter telemetry_val_9 mandate deterministic compliance for telemetry_val_10 and state invariant telemetry_val_11 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Inbound workloads for overview telemetry evaluate p95 latency matrices ensuring sub-15ms execution bounds across active operator hardware. Operational standard telemetry_val_12 and specification parameter telemetry_val_13 mandate deterministic compliance for telemetry_val_14 and state invariant telemetry_val_15 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Ed25519 public key-pairs validate manifest identity for telemetry alongside constant-time HMAC signature checks. Operational standard telemetry_val_16 and specification parameter telemetry_val_17 mandate deterministic compliance for telemetry_val_18 and state invariant telemetry_val_19 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">The executive DePIN architecture for Overview Telemetry governs regional cluster density using spatial hexagon resolution 8 indexing for telemetry. Operational standard overview_telemetry_metric_0 and specification parameter overview_telemetry_metric_1 mandate deterministic compliance for overview_telemetry_metric_2 and state invariant overview_telemetry_metric_3 under overview_telemetry.</p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-slate-300 leading-relaxed mb-4">Edge node daemons for telemetry stream operational telemetry to Go aggregators over encrypted WireGuard mTLS tunnels on port 8080. Operational standard overview_telemetry_metric_4 and specification parameter overview_telemetry_metric_5 mandate deterministic compliance for overview_telemetry_metric_6 and state invariant overview_telemetry_metric_7 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Daily compute earnings for overview_telemetry settle to host bank accounts through Stripe Connect ACH payout distributions under protocol v1.5.0. Operational standard overview_telemetry_metric_8 and specification parameter overview_telemetry_metric_9 mandate deterministic compliance for overview_telemetry_metric_10 and state invariant overview_telemetry_metric_11 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Inbound workloads for overview telemetry evaluate p95 latency matrices ensuring sub-15ms execution bounds across active operator hardware. Operational standard overview_telemetry_metric_12 and specification parameter overview_telemetry_metric_13 mandate deterministic compliance for overview_telemetry_metric_14 and state invariant overview_telemetry_metric_15 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Ed25519 public key-pairs validate manifest identity for telemetry alongside constant-time HMAC signature checks. Operational standard overview_telemetry_metric_16 and specification parameter overview_telemetry_metric_17 mandate deterministic compliance for overview_telemetry_metric_18 and state invariant overview_telemetry_metric_19 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">The executive DePIN architecture for Overview Telemetry governs regional cluster density using spatial hexagon resolution 8 indexing for telemetry. Operational standard telemetry_val_0 and specification parameter telemetry_val_1 mandate deterministic compliance for telemetry_val_2 and state invariant telemetry_val_3 under overview_telemetry.</p>
        <p className="text-slate-300 leading-relaxed mb-4">Edge node daemons for telemetry stream operational telemetry to Go aggregators over encrypted WireGuard mTLS tunnels on port 8080. Operational standard telemetry_val_4 and specification parameter telemetry_val_5 mandate deterministic compliance for telemetry_val_6 and state invariant telemetry_val_7 under overview_telemetry.</p>
      ...
      <section className="space-y-4">
        ...
        <figure className="doc-figure my-8 rounded-xl border border-white/10 bg-[#0E0E10] p-4 shadow-2xl transition-all hover:border-[#00FFB2]/40">
          <img loading="lazy"
            ...
            alt="Fig 1.1 – Overview Telemetry Architecture Diagram"
          ...
          <figcaption className="mt-3 text-xs text-gray-400 leading-relaxed flex items-center justify-between">
            <span><strong className="text-gray-200">Fig 1.1</strong> – Canonical architectural flow and subsystem interactions for overview/telemetry.</span>
