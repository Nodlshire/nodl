    ...
    return (
        <>
            ...
            <p className="text-slate-300 leading-relaxed mb-6">
                In a complex distributed system, ambiguous terminology leads to architectural drift. If one engineer thinks "Sandbox" means a Docker container, and another thinks it means a Go Sandbox runtime, security boundaries fail.
            </p>
            <p className="text-slate-300 leading-relaxed mb-6">
            ...
            <div className="my-12 p-8 bg-slate-900/50 rounded-xl border border-slate-800 flex items-center justify-center">
                <svg viewBox="0 0 800 350" className="w-full drop-shadow-2xl font-sans text-sm">
                    ...
                    <text x="400" y="280" fill="white" fontWeight="bold" textAnchor="middle">Go Sandbox Sandbox</text>
            ...
            <dl className="mt-8 space-y-8">
                ...
                <div className="pb-8 border-b border-slate-800/50">
                    <dt className="text-xl font-bold text-white mb-2 font-space-grotesk">Go Sandbox</dt>
            ...
            <p className="text-slate-300 leading-relaxed mb-6">
                Terminology spans across the entire toolchain. When an error log mentions <code>Go Sandbox OutOfMemory</code>, both the Operator and the Developer must have an identical mental model of what exactly breached the <code>Substrate Model</code> bounds.
            </p>
