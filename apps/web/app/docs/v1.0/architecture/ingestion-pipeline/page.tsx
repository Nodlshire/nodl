...
export default function Page() {
    return (
        <div className="w-full pb-24">
            ...
            <p className="text-[16px] leading-[1.7] text-[#e5e7eb] mb-[16px]">Deep dive into the architecture of ingestion-pipeline.</p>
            ...
            <div className="mt-[20px] mb-[20px]">
                <div className="bg-[#0d1117] border border-slate-800 rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="p-4 overflow-x-auto">
                        <pre className="text-[14px] font-mono text-[#e5e7eb] leading-[1.5]"><code>{`// ingestion-pipeline code
func Init() {}`}</code></pre>
                    </div>
                </div>
            </div>
