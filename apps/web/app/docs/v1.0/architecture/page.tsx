...
export default function Page() {
    return (
        <div className="w-full pb-24">
            <h1 className="text-[28px] md:text-[32px] font-bold text-[#f9fafb] mb-[12px] leading-tight tracking-tight">{`Mesh Architecture`}</h1>
            ...
            <p className="text-[16px] leading-[1.7] text-[#e5e7eb] mb-[16px]">The Sovereign Mesh is split into the Earth Mesh (synchronous, low-latency, bare-metal fiber) and the Space Mesh (asynchronous, satellite-based, MapReduce).</p>

            {/* 3. Flow */}
            <h2 className="text-[22px] md:text-[24px] font-semibold text-[#f9fafb] mt-[32px] mb-[12px]">Flow</h2>
            <p className="text-[16px] leading-[1.7] text-[#e5e7eb] mb-[16px]">Orchestrator receives request -&gt; Evaluates latency requirements -&gt; Routes to Earth Tier-1 nodes OR Space Tier-3 nodes.</p>
            ...
            <div className="mt-[20px] mb-[20px]">
                <div className="bg-[#0d1117] border border-slate-800 rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="p-4 overflow-x-auto">
                        <pre className="text-[14px] font-mono text-[#e5e7eb] leading-[1.5]"><code>{`if req.Latency < 50*time.Millisecond {
  routeToEarthMesh()
} else {
  routeToSpaceMesh()
}`}</code></pre>
            ...
            <p className="text-[16px] leading-[1.7] text-[#e5e7eb] mb-[16px]">Node partition from the Orchestrator results in job reassignment to healthy Quorum.</p>
            ...
            <p className="text-[16px] leading-[1.7] text-[#e5e7eb] mb-[16px]">Earth Mesh guarantees &lt;50ms hops. Space Mesh guarantees high censorship resistance and async reliability. [STATUS: Pilot Mode. Full technical implementation details in Phase 4]</p>
