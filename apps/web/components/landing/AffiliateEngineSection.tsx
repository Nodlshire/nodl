                ...
                <div className="bg-gradient-to-b from-slate-950 via-slate-900/90 to-slate-950 border border-purple-500/30 rounded-3xl p-8 md:p-14 backdrop-blur-2xl shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-7 space-y-6">
                        ...
                        <div className="space-y-4 pt-2">
                            ...
                            <div className="bg-emerald-950/40 border border-emerald-500/50 p-4 rounded-2xl flex items-start gap-4 hover:border-emerald-400/70 transition-all shadow-[0_0_20px_rgba(16,185,129,0.15)]">
                                <div className="text-2xl p-2 bg-emerald-500/20 rounded-xl text-emerald-400 font-bold font-mono">70%</div>
                                <div>
                                    <div className="flex items-center gap-2">
                                        <h4 className="text-white font-bold text-base font-space-grotesk">70% Node Operator Revenue Share</h4>
                                    ...
                                    <p className="text-xs text-slate-300">The node operator retains 70% of all gross compute revenue generated by their connected hardware.</p>
                                </div>
                            </div>
                    ...
                    <div className="lg:col-span-5 bg-slate-950 border border-slate-800 p-8 rounded-3xl space-y-6 text-center shadow-2xl relative overflow-hidden">
                        ...
                        <div className="bg-slate-900/90 border border-slate-800 p-4 rounded-2xl text-left text-xs font-mono space-y-2 text-slate-300">
                            <div className="flex justify-between border-b border-slate-800 pb-2">
                                ...
                                <strong className="text-emerald-400">70% Compute Payout</strong>
                            </div>
                            <div className="flex justify-between border-b border-slate-800 pb-2">
