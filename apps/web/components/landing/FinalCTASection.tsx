...
export default function FinalCTASection({ onOpenModal }: FinalCTASectionProps) {
    return (
        <section className="py-24 bg-black text-white relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-to-tr from-blue-600/20 via-indigo-600/10 to-purple-600/20 rounded-full blur-[140px] pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                ...
                <div className="bg-gradient-to-b from-slate-900/90 to-slate-950/95 border border-slate-800 rounded-3xl p-10 md:p-16 text-center space-y-8 backdrop-blur-2xl shadow-[0_0_80px_rgba(0,0,0,0.9)] max-w-4xl mx-auto">
                    ...
                    <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs px-4 py-1.5 rounded-full font-mono font-bold uppercase tracking-wider">
                        <span>Get Started In 3 Clicks</span>
                    </div>
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tight font-space-grotesk uppercase text-white leading-tight">
                        Start Earning With Your Hardware Today
                    </h2>

                    {/* Subheadline */}
                    <p className="text-slate-300 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                        Join over 1,400+ active nodes powering the world’s first sovereign RAM compute and DeWi mesh. Daily USD payouts via Stripe.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                        <a
                            ...
                            className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-base px-9 py-4 rounded-2xl transition-all shadow-[0_0_35px_rgba(59,130,246,0.6)] uppercase tracking-wider flex items-center justify-center gap-2"
                        >
