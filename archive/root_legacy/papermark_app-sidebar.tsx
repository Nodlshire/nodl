    ...
    >
      <SidebarHeader className="gap-y-8">
        <p className="hidden w-full justify-center text-2xl font-bold tracking-tighter text-black group-data-[collapsible=icon]:inline-flex dark:text-white">
          <Link href="/dashboard">
            <img src="/wnode-logo.svg" alt="Wnode Logo" className="h-6 w-auto" />
          </Link>
        </p>
        <p className="ml-2 flex items-center text-2xl font-bold tracking-tighter text-black group-data-[collapsible=icon]:hidden dark:text-white">
          <Link href="/dashboard" className="flex items-center">
            <img src="/wnode-logo.svg" alt="Wnode Logo" className="h-6 w-auto mr-2" />
            <span className="font-semibold text-white">Wnode Data Room</span>
          </Link>
      ...
      <SidebarFooter>
        <SidebarMenu className="group-data-[collapsible=icon]:hidden">
          <SidebarMenuItem>
            <div>
              {/* Banners disabled for Wnode */}

              <div className="mb-2">
                {/* Usage limits removed for open-source edition */}
              </div>
            </div>
          </SidebarMenuItem>
        </SidebarMenu>
