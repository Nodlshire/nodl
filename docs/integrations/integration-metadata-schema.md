...
> - **WHAT**: Core architectural specification for **Integration-metadata-schema** within the Wnode Sovereign Mesh network.
...
- **Integration Name**: integration-metadata-schema
- **Version**: 1.0.0
