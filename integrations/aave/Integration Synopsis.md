# Aave — Integration Synopsis

## 1. Summary
The Aave integration operates in the `Protocol` domain. 

**Purpose:** # Aave V3 Integration  Uses `@aave/math-utils` for reserve data.
...
- **Link:** https://cryptologos.cc/logos/aave-aave-logo.svg
- **Link:** https://docs.aave.com/developers/v/2.0/the-core-protocol/ui-pool-data-provider
...
```json
{
  ...
  "docs": [
    ...
    "https://docs.aave.com/developers/v/2.0/the-core-protocol/ui-pool-data-provider"
  ]
}
```
