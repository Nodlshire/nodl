# Aavegotchi — Integration Synopsis

## 1. Summary
The Aavegotchi integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aavegotchi infrastructure.
