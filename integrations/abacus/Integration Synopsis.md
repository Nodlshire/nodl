# Abacus — Integration Synopsis

## 1. Summary
The Abacus integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Abacus infrastructure.
