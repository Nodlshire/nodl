# Across — Integration Synopsis

## 1. Summary
The Across integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Across infrastructure.
