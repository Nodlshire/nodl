...
optimizationEngine.register('across', {
  get_opportunities: across.get_opportunities,
  simulate: across.simulate,
  execute: across.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('across', 'Bridges');
