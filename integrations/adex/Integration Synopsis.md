# Adex — Integration Synopsis

## 1. Summary
The Adex integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Adex infrastructure.
