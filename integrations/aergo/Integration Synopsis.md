# Aergo — Integration Synopsis

## 1. Summary
The Aergo integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aergo infrastructure.
