# Aerodrome — Integration Synopsis

## 1. Summary
The Aerodrome integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aerodrome infrastructure.
