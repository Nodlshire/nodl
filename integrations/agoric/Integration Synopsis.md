# Agoric — Integration Synopsis

## 1. Summary
The Agoric integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Agoric infrastructure.
