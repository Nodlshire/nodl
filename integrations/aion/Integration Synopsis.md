# Aion — Integration Synopsis

## 1. Summary
The Aion integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aion infrastructure.
