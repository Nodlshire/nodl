# Akash — Integration Synopsis

## 1. Summary
The Akash integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Akash infrastructure.
