# Alchemix — Integration Synopsis

## 1. Summary
The Alchemix integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Alchemix infrastructure.
