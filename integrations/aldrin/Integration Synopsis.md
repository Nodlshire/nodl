# Aldrin — Integration Synopsis

## 1. Summary
The Aldrin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aldrin infrastructure.
