# Aleph.Im — Integration Synopsis

## 1. Summary
The Aleph.Im integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aleph.Im infrastructure.
