# Alephzero — Integration Synopsis

## 1. Summary
The Alephzero integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Alephzero infrastructure.
