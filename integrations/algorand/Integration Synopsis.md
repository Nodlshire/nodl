# Algorand — Integration Synopsis

## 1. Summary
The Algorand integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Algorand infrastructure.
