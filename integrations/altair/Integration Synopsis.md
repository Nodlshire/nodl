# Altair — Integration Synopsis

## 1. Summary
The Altair integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Altair infrastructure.
