# Altlayer — Integration Synopsis

## 1. Summary
The Altlayer integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Altlayer infrastructure.
