# Amplify — Integration Synopsis

## 1. Summary
The Amplify integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Amplify infrastructure.
