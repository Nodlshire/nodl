# Amplitude — Integration Synopsis

## 1. Summary
The Amplitude integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Amplitude infrastructure.
