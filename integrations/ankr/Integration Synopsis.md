# Ankr — Integration Synopsis

## 1. Summary
The Ankr integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ankr infrastructure.
