# Ankrscan — Integration Synopsis

## 1. Summary
The Ankrscan integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ankrscan infrastructure.
