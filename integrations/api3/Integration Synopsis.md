# Api3 — Integration Synopsis

## 1. Summary
The Api3 integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Api3 infrastructure.
