# Apillon — Integration Synopsis

## 1. Summary
The Apillon integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Apillon infrastructure.
