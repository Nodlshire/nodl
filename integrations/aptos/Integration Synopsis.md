# Aptos — Integration Synopsis

## 1. Summary
The Aptos integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aptos infrastructure.
