# Aragon — Integration Synopsis

## 1. Summary
The Aragon integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aragon infrastructure.
