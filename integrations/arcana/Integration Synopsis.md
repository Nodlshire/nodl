# Arcana — Integration Synopsis

## 1. Summary
The Arcana integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Arcana infrastructure.
