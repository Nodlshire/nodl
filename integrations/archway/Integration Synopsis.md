# Archway — Integration Synopsis

## 1. Summary
The Archway integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Archway infrastructure.
