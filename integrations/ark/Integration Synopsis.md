# Ark — Integration Synopsis

## 1. Summary
The Ark integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ark infrastructure.
