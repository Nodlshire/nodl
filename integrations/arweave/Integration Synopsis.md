# Arweave — Integration Synopsis

## 1. Summary
The Arweave integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Arweave infrastructure.
