# Astar — Integration Synopsis

## 1. Summary
The Astar integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Astar infrastructure.
