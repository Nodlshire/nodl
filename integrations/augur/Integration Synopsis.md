# Augur — Integration Synopsis

## 1. Summary
The Augur integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Augur infrastructure.
