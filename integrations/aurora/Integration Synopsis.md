# Aurora — Integration Synopsis

## 1. Summary
The Aurora integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aurora infrastructure.
