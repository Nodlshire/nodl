# Autonolas — Integration Synopsis

## 1. Summary
The Autonolas integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Autonolas infrastructure.
