# Avail — Integration Synopsis

## 1. Summary
The Avail integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Avail infrastructure.
