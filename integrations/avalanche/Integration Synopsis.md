# Avalanche — Integration Synopsis

## 1. Summary
The Avalanche integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Avalanche infrastructure.
