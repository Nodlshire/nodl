# Axelar — Integration Synopsis

## 1. Summary
The Axelar integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Axelar infrastructure.
