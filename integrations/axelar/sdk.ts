...
optimizationEngine.register('axelar', {
  get_opportunities: axelar.get_opportunities,
  simulate: axelar.simulate,
  execute: axelar.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('axelar', 'Bridges');
