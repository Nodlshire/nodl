# Axieinfinity — Integration Synopsis

## 1. Summary
The Axieinfinity integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Axieinfinity infrastructure.
