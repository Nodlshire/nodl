# Aztec — Integration Synopsis

## 1. Summary
The Aztec integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Aztec infrastructure.
