# Bajun — Integration Synopsis

## 1. Summary
The Bajun integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bajun infrastructure.
