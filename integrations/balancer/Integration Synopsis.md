# Balancer — Integration Synopsis

## 1. Summary
The Balancer integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Balancer infrastructure.
