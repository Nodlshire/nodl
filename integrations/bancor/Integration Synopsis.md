# Bancor — Integration Synopsis

## 1. Summary
The Bancor integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bancor infrastructure.
