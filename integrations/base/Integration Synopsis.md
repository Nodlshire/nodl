# Base — Integration Synopsis

## 1. Summary
The Base integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Base infrastructure.
