# Basegoerli — Integration Synopsis

## 1. Summary
The Basegoerli integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Basegoerli infrastructure.
