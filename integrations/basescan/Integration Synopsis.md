# Basescan — Integration Synopsis

## 1. Summary
The Basescan integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Basescan infrastructure.
