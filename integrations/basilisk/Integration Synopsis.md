# Basilisk — Integration Synopsis

## 1. Summary
The Basilisk integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Basilisk infrastructure.
