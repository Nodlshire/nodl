# Bat — Integration Synopsis

## 1. Summary
The Bat integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bat infrastructure.
