# Berachain — Integration Synopsis

## 1. Summary
The Berachain integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Berachain infrastructure.
