# Bitcanna — Integration Synopsis

## 1. Summary
The Bitcanna integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bitcanna infrastructure.
