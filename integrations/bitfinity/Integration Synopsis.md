# Bitfinity — Integration Synopsis

## 1. Summary
The Bitfinity integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bitfinity infrastructure.
