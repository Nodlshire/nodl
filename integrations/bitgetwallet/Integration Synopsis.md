# Bitgetwallet — Integration Synopsis

## 1. Summary
The Bitgetwallet integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bitgetwallet infrastructure.
