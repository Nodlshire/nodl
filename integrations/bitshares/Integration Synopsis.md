# Bitshares — Integration Synopsis

## 1. Summary
The Bitshares integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bitshares infrastructure.
