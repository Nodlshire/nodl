# Bitte — Integration Synopsis

## 1. Summary
The Bitte integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bitte infrastructure.
