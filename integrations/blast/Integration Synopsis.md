# Blast — Integration Synopsis

## 1. Summary
The Blast integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Blast infrastructure.
