# Blockdaemon — Integration Synopsis

## 1. Summary
The Blockdaemon integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Blockdaemon infrastructure.
