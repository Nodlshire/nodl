# Blocknative — Integration Synopsis

## 1. Summary
The Blocknative integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Blocknative infrastructure.
