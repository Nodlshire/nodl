# Blockpi — Integration Synopsis

## 1. Summary
The Blockpi integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Blockpi infrastructure.
