# Bloxroute — Integration Synopsis

## 1. Summary
The Bloxroute integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bloxroute infrastructure.
