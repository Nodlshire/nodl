# Bob — Integration Synopsis

## 1. Summary
The Bob integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bob infrastructure.
