# Bosonprotocol — Integration Synopsis

## 1. Summary
The Bosonprotocol integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bosonprotocol infrastructure.
