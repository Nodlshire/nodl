# Braavos — Integration Synopsis

## 1. Summary
The Braavos integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Braavos infrastructure.
