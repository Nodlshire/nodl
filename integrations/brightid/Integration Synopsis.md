# Brightid — Integration Synopsis

## 1. Summary
The Brightid integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Brightid infrastructure.
