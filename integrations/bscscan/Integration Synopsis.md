# Bscscan — Integration Synopsis

## 1. Summary
The Bscscan integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bscscan infrastructure.
