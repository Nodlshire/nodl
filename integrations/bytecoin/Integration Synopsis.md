# Bytecoin — Integration Synopsis

## 1. Summary
The Bytecoin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Bytecoin infrastructure.
