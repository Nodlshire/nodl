# Canto — Integration Synopsis

## 1. Summary
The Canto integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Canto infrastructure.
