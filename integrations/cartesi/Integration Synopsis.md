# Cartesi — Integration Synopsis

## 1. Summary
The Cartesi integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Cartesi infrastructure.
