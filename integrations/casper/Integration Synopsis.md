# Casper — Integration Synopsis

## 1. Summary
The Casper integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Casper infrastructure.
