# Celer — Integration Synopsis

## 1. Summary
The Celer integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Celer infrastructure.
