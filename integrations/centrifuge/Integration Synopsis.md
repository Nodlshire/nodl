# Centrifuge — Integration Synopsis

## 1. Summary
The Centrifuge integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Centrifuge infrastructure.
