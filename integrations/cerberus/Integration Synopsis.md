# Cerberus — Integration Synopsis

## 1. Summary
The Cerberus integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Cerberus infrastructure.
