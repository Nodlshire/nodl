# Chainflip — Integration Synopsis

## 1. Summary
The Chainflip integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Chainflip infrastructure.
