# Chainjet — Integration Synopsis

## 1. Summary
The Chainjet integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Chainjet infrastructure.
