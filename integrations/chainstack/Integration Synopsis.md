# Chainstack — Integration Synopsis

## 1. Summary
The Chainstack integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Chainstack infrastructure.
