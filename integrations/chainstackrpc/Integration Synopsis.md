# Chainstackrpc — Integration Synopsis

## 1. Summary
The Chainstackrpc integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Chainstackrpc infrastructure.
