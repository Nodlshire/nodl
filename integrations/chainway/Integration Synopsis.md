# Chainway — Integration Synopsis

## 1. Summary
The Chainway integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Chainway infrastructure.
