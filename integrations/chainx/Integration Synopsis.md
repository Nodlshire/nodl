# Chainx — Integration Synopsis

## 1. Summary
The Chainx integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Chainx infrastructure.
