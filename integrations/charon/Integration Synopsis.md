# Charon — Integration Synopsis

## 1. Summary
The Charon integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Charon infrastructure.
