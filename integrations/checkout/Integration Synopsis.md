# Checkout.com — Integration Synopsis

## 1. Summary
The Checkout.com integration operates in the `payments / billing` domain. It provides capabilities including: M2M payments, stablecoin rails. 
...
- **Link:** https://cryptologos.cc/logos/checkout-logo.svg
...
```json
{
  ...
  "docs": [
    "https://cryptologos.cc/logos/checkout-logo.svg",
