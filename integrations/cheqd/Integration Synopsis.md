# Cheqd — Integration Synopsis

## 1. Summary
The Cheqd integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Cheqd infrastructure.
