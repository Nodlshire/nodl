# Chia — Integration Synopsis

## 1. Summary
The Chia integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Chia infrastructure.
