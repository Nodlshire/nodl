# Chihuahua — Integration Synopsis

## 1. Summary
The Chihuahua integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Chihuahua infrastructure.
