# Chiliz — Integration Synopsis

## 1. Summary
The Chiliz integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Chiliz infrastructure.
