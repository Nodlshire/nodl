# Circlecctp — Integration Synopsis

## 1. Summary
The Circlecctp integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Circlecctp infrastructure.
