# Circuit — Integration Synopsis

## 1. Summary
The Circuit integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Circuit infrastructure.
