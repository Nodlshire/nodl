# Civic — Integration Synopsis

## 1. Summary
The Civic integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Civic infrastructure.
