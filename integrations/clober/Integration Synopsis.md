# Clober — Integration Synopsis

## 1. Summary
The Clober integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Clober infrastructure.
