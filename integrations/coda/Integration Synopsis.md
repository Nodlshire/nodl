# Coda — Integration Synopsis

## 1. Summary
The Coda integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Coda infrastructure.
