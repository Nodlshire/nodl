# Coin98 — Integration Synopsis

## 1. Summary
The Coin98 integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Coin98 infrastructure.
