# Coinbasewallet — Integration Synopsis

## 1. Summary
The Coinbasewallet integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Coinbasewallet infrastructure.
