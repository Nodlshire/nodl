# Coingecko — Integration Synopsis

## 1. Summary
The Coingecko integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Coingecko infrastructure.
