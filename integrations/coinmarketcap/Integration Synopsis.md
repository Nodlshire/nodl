# Coinmarketcap — Integration Synopsis

## 1. Summary
The Coinmarketcap integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Coinmarketcap infrastructure.
