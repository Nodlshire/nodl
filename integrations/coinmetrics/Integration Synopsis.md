# Coinmetrics — Integration Synopsis

## 1. Summary
The Coinmetrics integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Coinmetrics infrastructure.
