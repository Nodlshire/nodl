# Comdex — Integration Synopsis

## 1. Summary
The Comdex integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Comdex infrastructure.
