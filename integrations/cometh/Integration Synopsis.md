# Cometh — Integration Synopsis

## 1. Summary
The Cometh integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Cometh infrastructure.
