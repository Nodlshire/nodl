# Compound — Integration Synopsis

## 1. Summary
The Compound integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Compound infrastructure.
