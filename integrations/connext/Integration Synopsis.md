# Connext — Integration Synopsis

## 1. Summary
The Connext integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Connext infrastructure.
