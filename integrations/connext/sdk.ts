...
optimizationEngine.register('connext', {
  get_opportunities: connext.get_opportunities,
  simulate: connext.simulate,
  execute: connext.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('connext', 'Bridges');
