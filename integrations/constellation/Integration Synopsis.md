# Constellation — Integration Synopsis

## 1. Summary
The Constellation integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Constellation infrastructure.
