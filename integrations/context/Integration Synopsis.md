# Context — Integration Synopsis

## 1. Summary
The Context integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Context infrastructure.
