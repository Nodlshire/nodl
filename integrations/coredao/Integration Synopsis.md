# Coredao — Integration Synopsis

## 1. Summary
The Coredao integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Coredao infrastructure.
