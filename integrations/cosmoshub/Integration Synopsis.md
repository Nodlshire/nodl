# Cosmoshub — Integration Synopsis

## 1. Summary
The Cosmoshub integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Cosmoshub infrastructure.
