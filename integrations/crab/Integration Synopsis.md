# Crab — Integration Synopsis

## 1. Summary
The Crab integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Crab infrastructure.
