# Crescent — Integration Synopsis

## 1. Summary
The Crescent integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Crescent infrastructure.
