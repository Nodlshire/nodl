# Cronos — Integration Synopsis

## 1. Summary
The Cronos integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Cronos infrastructure.
