# Crossmint — Integration Synopsis

## 1. Summary
The Crossmint integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Crossmint infrastructure.
