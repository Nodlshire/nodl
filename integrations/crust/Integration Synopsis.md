# Crust — Integration Synopsis

## 1. Summary
The Crust integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Crust infrastructure.
