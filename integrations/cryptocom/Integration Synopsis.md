# Cryptocom — Integration Synopsis

## 1. Summary
The Cryptocom integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Cryptocom infrastructure.
