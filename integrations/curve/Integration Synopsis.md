# Curve — Integration Synopsis

## 1. Summary
The Curve integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Curve infrastructure.
