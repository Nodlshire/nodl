...
optimizationEngine.register('curve', {
  get_opportunities: curve.get_opportunities,
  simulate: curve.simulate,
  execute: curve.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('curve', 'SpotDEX');
