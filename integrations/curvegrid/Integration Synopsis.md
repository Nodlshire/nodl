# Curvegrid — Integration Synopsis

## 1. Summary
The Curvegrid integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Curvegrid infrastructure.
