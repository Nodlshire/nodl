# Cyber — Integration Synopsis

## 1. Summary
The Cyber integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Cyber infrastructure.
