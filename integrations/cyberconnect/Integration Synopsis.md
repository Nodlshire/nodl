# Cyberconnect — Integration Synopsis

## 1. Summary
The Cyberconnect integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Cyberconnect infrastructure.
