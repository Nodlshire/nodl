# Dappnode — Integration Synopsis

## 1. Summary
The Dappnode integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dappnode infrastructure.
