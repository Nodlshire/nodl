# Dappsmith — Integration Synopsis

## 1. Summary
The Dappsmith integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dappsmith infrastructure.
