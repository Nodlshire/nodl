# Dash — Integration Synopsis

## 1. Summary
The Dash integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dash infrastructure.
