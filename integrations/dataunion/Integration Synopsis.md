# Dataunion — Integration Synopsis

## 1. Summary
The Dataunion integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dataunion infrastructure.
