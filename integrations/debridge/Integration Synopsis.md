# Debridge — Integration Synopsis

## 1. Summary
The Debridge integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Debridge infrastructure.
