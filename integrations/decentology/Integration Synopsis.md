# Decentology — Integration Synopsis

## 1. Summary
The Decentology integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Decentology infrastructure.
