# Deepdao — Integration Synopsis

## 1. Summary
The Deepdao integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Deepdao infrastructure.
