# Defender — Integration Synopsis

## 1. Summary
The Defender integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Defender infrastructure.
