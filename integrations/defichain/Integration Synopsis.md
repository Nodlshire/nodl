# Defichain — Integration Synopsis

## 1. Summary
The Defichain integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Defichain infrastructure.
