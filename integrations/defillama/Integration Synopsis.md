# Defillama — Integration Synopsis

## 1. Summary
The Defillama integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Defillama infrastructure.
