# Defipulse — Integration Synopsis

## 1. Summary
The Defipulse integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Defipulse infrastructure.
