# Degenchain — Integration Synopsis

## 1. Summary
The Degenchain integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Degenchain infrastructure.
