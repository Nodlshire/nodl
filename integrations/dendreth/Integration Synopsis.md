# Dendreth — Integration Synopsis

## 1. Summary
The Dendreth integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dendreth infrastructure.
