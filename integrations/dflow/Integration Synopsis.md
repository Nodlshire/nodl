# Dflow — Integration Synopsis

## 1. Summary
The Dflow integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dflow infrastructure.
