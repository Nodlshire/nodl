# Dgen — Integration Synopsis

## 1. Summary
The Dgen integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dgen infrastructure.
