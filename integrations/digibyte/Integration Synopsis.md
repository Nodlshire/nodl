# Digibyte — Integration Synopsis

## 1. Summary
The Digibyte integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Digibyte infrastructure.
