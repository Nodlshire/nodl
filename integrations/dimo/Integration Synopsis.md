# Dimo — Integration Synopsis

## 1. Summary
The Dimo integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dimo infrastructure.
