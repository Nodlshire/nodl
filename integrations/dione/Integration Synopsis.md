# Dione — Integration Synopsis

## 1. Summary
The Dione integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dione infrastructure.
