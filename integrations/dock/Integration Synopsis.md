# Dock — Integration Synopsis

## 1. Summary
The Dock integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dock infrastructure.
