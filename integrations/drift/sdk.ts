...
optimizationEngine.register('drift', {
  get_opportunities: drift.get_opportunities,
  simulate: drift.simulate,
  execute: drift.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('drift', 'Perps');
