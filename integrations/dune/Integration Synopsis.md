# Dune — Integration Synopsis

## 1. Summary
The Dune integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dune infrastructure.
