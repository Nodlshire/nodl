# Dusk — Integration Synopsis

## 1. Summary
The Dusk integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Dusk infrastructure.
