# Edennetwork — Integration Synopsis

## 1. Summary
The Edennetwork integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Edennetwork infrastructure.
