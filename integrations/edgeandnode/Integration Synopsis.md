# Edgeandnode — Integration Synopsis

## 1. Summary
The Edgeandnode integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Edgeandnode infrastructure.
