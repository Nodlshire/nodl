# Edgeware — Integration Synopsis

## 1. Summary
The Edgeware integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Edgeware infrastructure.
