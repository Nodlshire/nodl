# Efinity — Integration Synopsis

## 1. Summary
The Efinity integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Efinity infrastructure.
