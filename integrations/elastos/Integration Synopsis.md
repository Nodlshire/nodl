# Elastos — Integration Synopsis

## 1. Summary
The Elastos integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Elastos infrastructure.
