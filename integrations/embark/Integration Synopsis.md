# Embark — Integration Synopsis

## 1. Summary
The Embark integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Embark infrastructure.
