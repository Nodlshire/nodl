# Empyrean — Integration Synopsis

## 1. Summary
The Empyrean integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Empyrean infrastructure.
