# Energyweb — Integration Synopsis

## 1. Summary
The Energyweb integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Energyweb infrastructure.
