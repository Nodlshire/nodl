# Enjin — Integration Synopsis

## 1. Summary
The Enjin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Enjin infrastructure.
