# Ens — Integration Synopsis

## 1. Summary
The Ens integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ens infrastructure.
