# Ensvision — Integration Synopsis

## 1. Summary
The Ensvision integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ensvision infrastructure.
