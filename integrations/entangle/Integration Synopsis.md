# Entangle — Integration Synopsis

## 1. Summary
The Entangle integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Entangle infrastructure.
