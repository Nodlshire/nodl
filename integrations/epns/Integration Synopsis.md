# Epns — Integration Synopsis

## 1. Summary
The Epns integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Epns infrastructure.
