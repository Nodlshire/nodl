# Ergo — Integration Synopsis

## 1. Summary
The Ergo integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ergo infrastructure.
