# Ether.Fi — Integration Synopsis

## 1. Summary
The Ether.Fi integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ether.Fi infrastructure.
