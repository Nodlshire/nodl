# Etherfi — Integration Synopsis

## 1. Summary
The Etherfi integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Etherfi infrastructure.
