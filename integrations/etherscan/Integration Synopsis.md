# Etherscan — Integration Synopsis

## 1. Summary
The Etherscan integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Etherscan infrastructure.
