# Euler — Integration Synopsis

## 1. Summary
The Euler integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Euler infrastructure.
