...
- **evmoslogo.svg** — Integration asset — `./evmoslogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "evmoslogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
