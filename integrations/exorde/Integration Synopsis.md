...
- **exordelogo.svg** — Integration asset — `./exordelogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "exordelogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
