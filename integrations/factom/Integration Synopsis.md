...
- **factomlogo.svg** — Integration asset — `./factomlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "factomlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
