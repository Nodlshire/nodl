...
- **fantomlogo.svg** — Integration asset — `./fantomlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "fantomlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
