# Farcaster — Integration Synopsis
...
- **farcasterlogo.svg** — Integration asset — `./farcasterlogo.svg`
...
```json
{
  "integration": "Farcaster",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "farcasterlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
