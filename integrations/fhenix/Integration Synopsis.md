...
- **fhenixlogo.svg** — Integration asset — `./fhenixlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "fhenixlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
