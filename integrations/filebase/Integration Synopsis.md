...
- **filebaselogo.svg** — Integration asset — `./filebaselogo.svg`
...
```json
{
  "integration": "Filebase",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "filebaselogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
