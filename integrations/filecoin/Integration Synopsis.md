...
- **filecoinlogo.svg** — Integration asset — `./filecoinlogo.svg`
...
```json
{
  "integration": "Filecoin",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "filecoinlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
