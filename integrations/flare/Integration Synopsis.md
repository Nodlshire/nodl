...
- **flarelogo.svg** — Integration asset — `./flarelogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "flarelogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
