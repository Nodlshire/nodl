# Flashbots — Integration Synopsis
...
- **flashbotslogo.svg** — Integration asset — `./flashbotslogo.svg`
...
```json
{
  "integration": "Flashbots",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "flashbotslogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
