...
- **fortalogo.svg** — Integration asset — `./fortalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "fortalogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
