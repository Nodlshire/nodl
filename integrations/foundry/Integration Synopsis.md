...
- **foundrylogo.svg** — Integration asset — `./foundrylogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "foundrylogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
