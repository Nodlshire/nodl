...
- **fraxlogo.svg** — Integration asset — `./fraxlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "fraxlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
