...
- **fuellogo.svg** — Integration asset — `./fuellogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "fuellogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
