...
- **fuselogo.svg** — Integration asset — `./fuselogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "fuselogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
