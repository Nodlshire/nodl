# Galadriel — Integration Synopsis
...
- **galadriellogo.svg** — Integration asset — `./galadriellogo.svg`
...
```json
{
  "integration": "Galadriel",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "galadriellogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
