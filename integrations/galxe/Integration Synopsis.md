...
- **galxelogo.svg** — Integration asset — `./galxelogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "galxelogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
