...
- **gateiologo.svg** — Integration asset — `./gateiologo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "gateiologo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
