# Gelatoops — Integration Synopsis
...
- **gelatoopslogo.svg** — Integration asset — `./gelatoopslogo.svg`
...
```json
{
  "integration": "Gelatoops",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "gelatoopslogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
