...
- **geminislogo.svg** — Integration asset — `./geminislogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "geminislogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
