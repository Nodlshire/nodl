...
- **genlayerlogo.svg** — Integration asset — `./genlayerlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "genlayerlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
