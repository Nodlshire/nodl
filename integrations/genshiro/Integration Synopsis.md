...
- **genshirologo.svg** — Integration asset — `./genshirologo.svg`
...
```json
{
  "integration": "Genshiro",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "genshirologo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
