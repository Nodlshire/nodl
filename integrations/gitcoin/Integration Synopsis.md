...
- **gitcoinlogo.svg** — Integration asset — `./gitcoinlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "gitcoinlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
