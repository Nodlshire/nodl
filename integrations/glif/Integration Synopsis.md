...
- **gliflogo.svg** — Integration asset — `./gliflogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "gliflogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
