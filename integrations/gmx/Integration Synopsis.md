...
- **gmxlogo.svg** — Integration asset — `./gmxlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "gmxlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
