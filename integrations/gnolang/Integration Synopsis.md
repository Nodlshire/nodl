...
- **gnolanglogo.svg** — Integration asset — `./gnolanglogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "gnolanglogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
