...
- **gnosislogo.svg** — Integration asset — `./gnosislogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "gnosislogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
