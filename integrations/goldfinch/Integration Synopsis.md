# Goldfinch — Integration Synopsis
...
- **goldfinchlogo.svg** — Integration asset — `./goldfinchlogo.svg`
...
```json
{
  "integration": "Goldfinch",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "goldfinchlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
