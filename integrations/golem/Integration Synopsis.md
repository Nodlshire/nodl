...
- **golemlogo.svg** — Integration asset — `./golemlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "golemlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
