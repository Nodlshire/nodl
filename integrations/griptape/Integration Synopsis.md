...
- **griptapelogo.svg** — Integration asset — `./griptapelogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "griptapelogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
