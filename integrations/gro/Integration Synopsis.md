...
- **grologo.svg** — Integration asset — `./grologo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "grologo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
