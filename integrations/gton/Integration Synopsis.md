...
- **gtonlogo.svg** — Integration asset — `./gtonlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "gtonlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
