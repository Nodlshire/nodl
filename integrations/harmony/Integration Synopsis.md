...
- **harmonylogo.svg** — Integration asset — `./harmonylogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "harmonylogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
