...
- **hashflowlogo.svg** — Integration asset — `./hashflowlogo.svg`
...
```json
{
  "integration": "Hashflow",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "hashflowlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
