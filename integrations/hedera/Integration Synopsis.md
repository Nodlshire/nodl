...
- **hederalogo.svg** — Integration asset — `./hederalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "hederalogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
