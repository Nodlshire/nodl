...
- **heliuslogo.svg** — Integration asset — `./heliuslogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "heliuslogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
