# Herodotus — Integration Synopsis
...
- **herodotuslogo.svg** — Integration asset — `./herodotuslogo.svg`
...
```json
{
  "integration": "Herodotus",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "herodotuslogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
