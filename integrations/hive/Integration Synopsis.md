...
- **hivelogo.svg** — Integration asset — `./hivelogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "hivelogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
