# Hivemapper — Integration Synopsis
...
- **hivemapperlogo.svg** — Integration asset — `./hivemapperlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "hivemapperlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
