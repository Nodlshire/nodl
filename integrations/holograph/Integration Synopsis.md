# Holograph — Integration Synopsis
...
- **holographlogo.svg** — Integration asset — `./holographlogo.svg`
...
```json
{
  "integration": "Holograph",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "holographlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
