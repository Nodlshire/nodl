...
- **hoprlogo.svg** — Integration asset — `./hoprlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "hoprlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
