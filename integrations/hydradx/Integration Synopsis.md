...
- **hydradxlogo.svg** — Integration asset — `./hydradxlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "hydradxlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
