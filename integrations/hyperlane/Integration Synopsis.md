# Hyperlane — Integration Synopsis
...
- **hyperlanelogo.svg** — Integration asset — `./hyperlanelogo.svg`
...
```json
{
  "integration": "Hyperlane",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "hyperlanelogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
