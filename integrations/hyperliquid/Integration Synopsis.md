# Hyperliquid — Integration Synopsis
...
- **hyperliquidlogo.svg** — Integration asset — `./hyperliquidlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "hyperliquidlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
