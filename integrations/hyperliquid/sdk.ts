...
optimizationEngine.register('hyperliquid', {
  get_opportunities: hyperliquid.get_opportunities,
  simulate: hyperliquid.simulate,
  execute: hyperliquid.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('hyperliquid', 'Perps');
