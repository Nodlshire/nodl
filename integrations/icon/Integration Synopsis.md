...
- **iconlogo.svg** — Integration asset — `./iconlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "iconlogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
