...
- **icplogo.svg** — Integration asset — `./icplogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "icplogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
