...
- **immunefilogo.svg** — Integration asset — `./immunefilogo.svg`
...
```json
{
  "integration": "Immunefi",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "immunefilogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
