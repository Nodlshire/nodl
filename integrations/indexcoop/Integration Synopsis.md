# Indexcoop — Integration Synopsis
...
- **indexcooplogo.svg** — Integration asset — `./indexcooplogo.svg`
...
```json
{
  "integration": "Indexcoop",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "indexcooplogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
