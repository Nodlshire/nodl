# Infstones — Integration Synopsis
...
- **infstoneslogo.svg** — Integration asset — `./infstoneslogo.svg`
...
```json
{
  "integration": "Infstones",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "infstoneslogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
