...
- **infuralogo.svg** — Integration asset — `./infuralogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "infuralogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
