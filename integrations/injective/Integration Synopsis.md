# Injective — Integration Synopsis
...
- **injectivelogo.svg** — Integration asset — `./injectivelogo.svg`
...
```json
{
  "integration": "Injective",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "injectivelogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
