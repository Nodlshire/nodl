...
optimizationEngine.register('injective', {
  get_opportunities: injective.get_opportunities,
  simulate: injective.simulate,
  execute: injective.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('injective', 'Perps');
