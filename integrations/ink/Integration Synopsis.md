...
- **inklogo.svg** — Integration asset — `./inklogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "inklogo.svg", "integration.md", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
