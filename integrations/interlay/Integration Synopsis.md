...
- **interlaylogo.svg** — Integration asset — `./interlaylogo.svg`
...
```json
{
  "integration": "Interlay",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "integration.md", "interlaylogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
