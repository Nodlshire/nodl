...
- **io.netlogo.svg** — Integration asset — `./io.netlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "io.netlogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
