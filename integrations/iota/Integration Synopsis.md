...
- **iotalogo.svg** — Integration asset — `./iotalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "iotalogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
