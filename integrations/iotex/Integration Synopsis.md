...
- **iotexlogo.svg** — Integration asset — `./iotexlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "iotexlogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
