...
- **ipfslogo.svg** — Integration asset — `./ipfslogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "ipfslogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
