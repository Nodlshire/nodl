...
- **irisnetlogo.svg** — Integration asset — `./irisnetlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "irisnetlogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
