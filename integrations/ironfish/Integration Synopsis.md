...
- **ironfishlogo.svg** — Integration asset — `./ironfishlogo.svg`
...
```json
{
  "integration": "Ironfish",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "integration.md", "ironfishlogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
