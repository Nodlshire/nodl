...
- **jitologo.svg** — Integration asset — `./jitologo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "jitologo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
