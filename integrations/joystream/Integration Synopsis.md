# Joystream — Integration Synopsis
...
- **joystreamlogo.svg** — Integration asset — `./joystreamlogo.svg`
...
```json
{
  "integration": "Joystream",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "integration.md", "joystreamlogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
