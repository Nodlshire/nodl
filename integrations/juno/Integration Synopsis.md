...
- **junologo.svg** — Integration asset — `./junologo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "junologo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
