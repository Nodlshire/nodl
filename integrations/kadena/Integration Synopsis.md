...
- **kadenalogo.svg** — Integration asset — `./kadenalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kadenalogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
