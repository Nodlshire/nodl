...
- **kakarotlogo.svg** — Integration asset — `./kakarotlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kakarotlogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
