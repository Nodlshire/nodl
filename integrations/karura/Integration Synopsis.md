...
- **karuralogo.svg** — Integration asset — `./karuralogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "karuralogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
