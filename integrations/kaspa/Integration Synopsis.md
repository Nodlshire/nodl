...
- **kaspalogo.svg** — Integration asset — `./kaspalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kaspalogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
