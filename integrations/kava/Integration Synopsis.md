...
- **kavalogo.svg** — Integration asset — `./kavalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kavalogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
