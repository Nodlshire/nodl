...
- **kelpdaologo.svg** — Integration asset — `./kelpdaologo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kelpdaologo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
