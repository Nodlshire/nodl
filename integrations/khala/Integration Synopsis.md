...
- **khalalogo.svg** — Integration asset — `./khalalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "khalalogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
