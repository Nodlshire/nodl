...
- **kilogo.svg** — Integration asset — `./kilogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kilogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
