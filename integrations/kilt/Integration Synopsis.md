...
- **kiltlogo.svg** — Integration asset — `./kiltlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kiltlogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
