...
- **kintologo.svg** — Integration asset — `./kintologo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kintologo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
