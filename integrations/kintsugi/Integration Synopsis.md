...
- **kintsugilogo.svg** — Integration asset — `./kintsugilogo.svg`
...
```json
{
  "integration": "Kintsugi",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "integration.md", "kintsugilogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
