...
- **klaytnlogo.svg** — Integration asset — `./klaytnlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "klaytnlogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
