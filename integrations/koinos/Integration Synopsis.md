...
- **koinoslogo.svg** — Integration asset — `./koinoslogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "koinoslogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
