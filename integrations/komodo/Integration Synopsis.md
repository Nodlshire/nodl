...
- **komodologo.svg** — Integration asset — `./komodologo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "komodologo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
