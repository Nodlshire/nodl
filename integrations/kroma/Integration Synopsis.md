...
- **kromalogo.svg** — Integration asset — `./kromalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kromalogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
