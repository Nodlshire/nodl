...
- **kusamalogo.svg** — Integration asset — `./kusamalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kusamalogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
