...
- **kwentalogo.svg** — Integration asset — `./kwentalogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kwentalogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
