...
optimizationEngine.register('kwenta', {
  get_opportunities: kwenta.get_opportunities,
  simulate: kwenta.simulate,
  execute: kwenta.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('kwenta', 'Perps');
