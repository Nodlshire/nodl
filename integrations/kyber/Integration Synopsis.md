...
- **kyberlogo.svg** — Integration asset — `./kyberlogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kyberlogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
