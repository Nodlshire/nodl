...
- **kyvelogo.svg** — Integration asset — `./kyvelogo.svg`
...
```json
{
  ...
  "files": ["activation_placeholder.txt", "integration.md", "kyvelogo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
