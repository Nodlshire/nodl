# Layerzero — Integration Synopsis
...
- **layerzerologo.svg** — Integration asset — `./layerzerologo.svg`
...
```json
{
  "integration": "Layerzero",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false
  },
  "files": ["activation_placeholder.txt", "integration.md", "layerzerologo.svg", "manifest.json", "sdk.ts", "status.json", "integration.json", "Integration Synopsis.md"],
  "docs": []
}
```
