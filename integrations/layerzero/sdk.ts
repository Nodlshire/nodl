...
optimizationEngine.register('layerzero', {
  get_opportunities: layerzero.get_opportunities,
  simulate: layerzero.simulate,
  execute: layerzero.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('layerzero', 'Bridges');
