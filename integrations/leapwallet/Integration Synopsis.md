# Leapwallet — Integration Synopsis

## 1. Summary
The Leapwallet integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Leapwallet infrastructure.
