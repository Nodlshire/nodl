# Ledgerlive — Integration Synopsis

## 1. Summary
The Ledgerlive integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ledgerlive infrastructure.
