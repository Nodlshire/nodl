# Lensprotocol — Integration Synopsis

## 1. Summary
The Lensprotocol integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Lensprotocol infrastructure.
