# Lido — Integration Synopsis

## 1. Summary
The Lido integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Lido infrastructure.
