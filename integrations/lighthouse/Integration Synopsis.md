# Lighthouse — Integration Synopsis

## 1. Summary
The Lighthouse integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Lighthouse infrastructure.
