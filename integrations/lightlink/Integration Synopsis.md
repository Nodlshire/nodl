# Lightlink — Integration Synopsis

## 1. Summary
The Lightlink integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Lightlink infrastructure.
