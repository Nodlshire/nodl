# Lightning — Integration Synopsis

## 1. Summary
The Lightning integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Lightning infrastructure.
