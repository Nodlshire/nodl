# Liquity — Integration Synopsis

## 1. Summary
The Liquity integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Liquity infrastructure.
