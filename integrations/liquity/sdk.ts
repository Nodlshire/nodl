...
optimizationEngine.register('liquity', {
  get_opportunities: liquity.get_opportunities,
  simulate: liquity.simulate,
  execute: liquity.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('liquity', 'Lending');
