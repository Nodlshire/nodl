# Lisk — Integration Synopsis

## 1. Summary
The Lisk integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Lisk infrastructure.
