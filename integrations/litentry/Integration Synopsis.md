# Litentry — Integration Synopsis

## 1. Summary
The Litentry integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Litentry infrastructure.
