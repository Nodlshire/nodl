# Litprotocol — Integration Synopsis

## 1. Summary
The Litprotocol integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Litprotocol infrastructure.
