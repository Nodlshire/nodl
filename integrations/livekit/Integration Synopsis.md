# Livekit — Integration Synopsis

## 1. Summary
The Livekit integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Livekit infrastructure.
