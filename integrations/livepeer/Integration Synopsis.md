# Livepeer — Integration Synopsis

## 1. Summary
The Livepeer integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Livepeer infrastructure.
