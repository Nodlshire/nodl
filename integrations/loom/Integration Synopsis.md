# Loom — Integration Synopsis

## 1. Summary
The Loom integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Loom infrastructure.
