# Loopring — Integration Synopsis

## 1. Summary
The Loopring integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Loopring infrastructure.
