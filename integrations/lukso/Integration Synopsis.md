# Lukso — Integration Synopsis

## 1. Summary
The Lukso integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Lukso infrastructure.
