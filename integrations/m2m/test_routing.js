...
async function runTests() {
    ...
    for (const c of cases) {
        const res = await (0, psp_dispatcher_1.dispatchPayment)(c.upo);
    ...
    const resFailover = await (0, psp_dispatcher_1.dispatchPayment)(fallbackUpo, 'stripe');
