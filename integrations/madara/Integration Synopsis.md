# Madara — Integration Synopsis

## 1. Summary
The Madara integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Madara infrastructure.
