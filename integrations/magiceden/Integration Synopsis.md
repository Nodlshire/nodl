# Magiceden — Integration Synopsis

## 1. Summary
The Magiceden integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Magiceden infrastructure.
