# Magiclink — Integration Synopsis

## 1. Summary
The Magiclink integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Magiclink infrastructure.
