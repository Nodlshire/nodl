# Maidsafecoin — Integration Synopsis

## 1. Summary
The Maidsafecoin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Maidsafecoin infrastructure.
