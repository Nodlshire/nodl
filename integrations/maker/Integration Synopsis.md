# Maker — Integration Synopsis

## 1. Summary
The Maker integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Maker infrastructure.
