# Makerdao — Integration Synopsis

## 1. Summary
The Makerdao integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Makerdao infrastructure.
