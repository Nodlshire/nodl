# Mangata — Integration Synopsis

## 1. Summary
The Mangata integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mangata infrastructure.
