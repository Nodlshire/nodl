# Manta — Integration Synopsis

## 1. Summary
The Manta integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Manta infrastructure.
