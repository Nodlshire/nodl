# Mantle — Integration Synopsis

## 1. Summary
The Mantle integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mantle infrastructure.
