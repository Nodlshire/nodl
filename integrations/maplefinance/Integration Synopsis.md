# Maplefinance — Integration Synopsis

## 1. Summary
The Maplefinance integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Maplefinance infrastructure.
