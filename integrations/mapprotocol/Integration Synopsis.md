# Mapprotocol — Integration Synopsis

## 1. Summary
The Mapprotocol integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mapprotocol infrastructure.
