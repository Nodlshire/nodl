...
optimizationEngine.register('marginfi', {
  get_opportunities: marginfi.get_opportunities,
  simulate: marginfi.simulate,
  execute: marginfi.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('marginfi', 'Lending');
