# Marlin — Integration Synopsis

## 1. Summary
The Marlin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Marlin infrastructure.
