# Marsprotocol — Integration Synopsis

## 1. Summary
The Marsprotocol integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Marsprotocol infrastructure.
