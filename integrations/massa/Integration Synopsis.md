# Massa — Integration Synopsis

## 1. Summary
The Massa integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Massa infrastructure.
