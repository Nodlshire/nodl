# Mathchain — Integration Synopsis

## 1. Summary
The Mathchain integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mathchain infrastructure.
