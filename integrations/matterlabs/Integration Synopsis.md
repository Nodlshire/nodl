# Matterlabs — Integration Synopsis

## 1. Summary
The Matterlabs integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Matterlabs infrastructure.
