# Maya — Integration Synopsis

## 1. Summary
The Maya integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Maya infrastructure.
