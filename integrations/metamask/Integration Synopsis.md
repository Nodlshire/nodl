# Metamask — Integration Synopsis

## 1. Summary
The Metamask integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Metamask infrastructure.
