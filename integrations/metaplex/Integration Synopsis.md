# Metaplex — Integration Synopsis

## 1. Summary
The Metaplex integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Metaplex infrastructure.
