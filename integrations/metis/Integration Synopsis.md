# Metis — Integration Synopsis

## 1. Summary
The Metis integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Metis infrastructure.
