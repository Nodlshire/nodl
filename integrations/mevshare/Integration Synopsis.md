# Mevshare — Integration Synopsis

## 1. Summary
The Mevshare integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mevshare infrastructure.
