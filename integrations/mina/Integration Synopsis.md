# Mina — Integration Synopsis

## 1. Summary
The Mina integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mina infrastructure.
