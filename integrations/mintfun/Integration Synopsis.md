# Mintfun — Integration Synopsis

## 1. Summary
The Mintfun integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mintfun infrastructure.
