# Mintkudos — Integration Synopsis

## 1. Summary
The Mintkudos integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mintkudos infrastructure.
