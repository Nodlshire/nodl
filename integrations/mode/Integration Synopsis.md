# Mode — Integration Synopsis

## 1. Summary
The Mode integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mode infrastructure.
