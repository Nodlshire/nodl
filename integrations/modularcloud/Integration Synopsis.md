# Modularcloud — Integration Synopsis

## 1. Summary
The Modularcloud integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Modularcloud infrastructure.
