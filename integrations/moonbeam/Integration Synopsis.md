# Moonbeam — Integration Synopsis

## 1. Summary
The Moonbeam integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Moonbeam infrastructure.
