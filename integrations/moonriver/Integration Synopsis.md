# Moonriver — Integration Synopsis

## 1. Summary
The Moonriver integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Moonriver infrastructure.
