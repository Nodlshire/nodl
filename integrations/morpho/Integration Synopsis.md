# Morpho — Integration Synopsis

## 1. Summary
The Morpho integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Morpho infrastructure.
