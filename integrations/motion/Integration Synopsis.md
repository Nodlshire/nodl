# Motion — Integration Synopsis

## 1. Summary
The Motion integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Motion infrastructure.
