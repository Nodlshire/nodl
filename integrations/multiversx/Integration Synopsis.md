# Multiversx — Integration Synopsis

## 1. Summary
The Multiversx integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Multiversx infrastructure.
