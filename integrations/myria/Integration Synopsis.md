# Myria — Integration Synopsis

## 1. Summary
The Myria integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Myria infrastructure.
