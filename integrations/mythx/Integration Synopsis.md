# Mythx — Integration Synopsis

## 1. Summary
The Mythx integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Mythx infrastructure.
