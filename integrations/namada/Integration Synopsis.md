# Namada — Integration Synopsis

## 1. Summary
The Namada integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Namada infrastructure.
