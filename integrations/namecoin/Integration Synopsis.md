# Namecoin — Integration Synopsis

## 1. Summary
The Namecoin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Namecoin infrastructure.
