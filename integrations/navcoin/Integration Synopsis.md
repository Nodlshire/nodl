# Navcoin — Integration Synopsis

## 1. Summary
The Navcoin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Navcoin infrastructure.
