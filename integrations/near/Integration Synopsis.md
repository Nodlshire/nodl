# Near — Integration Synopsis

## 1. Summary
The Near integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Near infrastructure.
