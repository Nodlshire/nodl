# Neo — Integration Synopsis

## 1. Summary
The Neo integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Neo infrastructure.
