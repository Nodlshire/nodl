# Neon — Integration Synopsis

## 1. Summary
The Neon integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Neon infrastructure.
