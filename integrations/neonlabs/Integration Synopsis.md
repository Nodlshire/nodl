# Neonlabs — Integration Synopsis

## 1. Summary
The Neonlabs integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Neonlabs infrastructure.
