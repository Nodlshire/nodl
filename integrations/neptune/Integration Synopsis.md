# Neptune — Integration Synopsis

## 1. Summary
The Neptune integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Neptune infrastructure.
