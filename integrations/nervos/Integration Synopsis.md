# Nervos — Integration Synopsis

## 1. Summary
The Nervos integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Nervos infrastructure.
