# Nethermind — Integration Synopsis

## 1. Summary
The Nethermind integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Nethermind infrastructure.
