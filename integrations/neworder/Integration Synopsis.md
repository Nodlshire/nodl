# Neworder — Integration Synopsis

## 1. Summary
The Neworder integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Neworder infrastructure.
