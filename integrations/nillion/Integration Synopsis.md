# Nillion — Integration Synopsis

## 1. Summary
The Nillion integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Nillion infrastructure.
