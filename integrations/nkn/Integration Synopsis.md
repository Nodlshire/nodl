# Nkn — Integration Synopsis

## 1. Summary
The Nkn integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Nkn infrastructure.
