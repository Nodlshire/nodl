# Noble — Integration Synopsis

## 1. Summary
The Noble integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Noble infrastructure.
