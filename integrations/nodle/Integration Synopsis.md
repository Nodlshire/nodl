# Nodle — Integration Synopsis

## 1. Summary
The Nodle integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Nodle infrastructure.
