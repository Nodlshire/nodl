# Nomic — Integration Synopsis

## 1. Summary
The Nomic integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Nomic infrastructure.
