# Notional — Integration Synopsis

## 1. Summary
The Notional integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Notional infrastructure.
