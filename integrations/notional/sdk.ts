...
optimizationEngine.register('notional', {
  get_opportunities: notional.get_opportunities,
  simulate: notional.simulate,
  execute: notional.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('notional', 'Lending');
