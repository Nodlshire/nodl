# Obscuro — Integration Synopsis

## 1. Summary
The Obscuro integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Obscuro infrastructure.
