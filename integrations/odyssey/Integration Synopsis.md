# Odyssey — Integration Synopsis

## 1. Summary
The Odyssey integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Odyssey infrastructure.
