# Omisego — Integration Synopsis

## 1. Summary
The Omisego integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Omisego infrastructure.
