# Onfinality — Integration Synopsis

## 1. Summary
The Onfinality integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Onfinality infrastructure.
