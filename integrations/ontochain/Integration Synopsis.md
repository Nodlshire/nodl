# Ontochain — Integration Synopsis

## 1. Summary
The Ontochain integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ontochain infrastructure.
