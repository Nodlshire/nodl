# Ontology — Integration Synopsis

## 1. Summary
The Ontology integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ontology infrastructure.
