# Opensea — Integration Synopsis

## 1. Summary
The Opensea integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Opensea infrastructure.
