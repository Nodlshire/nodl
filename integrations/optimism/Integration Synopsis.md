# Optimism — Integration Synopsis

## 1. Summary
The Optimism integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Optimism infrastructure.
