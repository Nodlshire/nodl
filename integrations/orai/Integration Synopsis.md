# Orai — Integration Synopsis

## 1. Summary
The Orai integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Orai infrastructure.
