# Pimlico — Integration Synopsis

## 1. Summary
The Pimlico integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Pimlico infrastructure.
