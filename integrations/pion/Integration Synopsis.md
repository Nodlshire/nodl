# Pion — Integration Synopsis

## 1. Summary
The Pion integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Pion infrastructure.
