# Pisa — Integration Synopsis

## 1. Summary
The Pisa integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Pisa infrastructure.
