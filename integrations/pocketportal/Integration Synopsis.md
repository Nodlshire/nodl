# Pocketportal — Integration Synopsis

## 1. Summary
The Pocketportal integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Pocketportal infrastructure.
