# Polkadot — Integration Synopsis

## 1. Summary
The Polkadot integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Polkadot infrastructure.
