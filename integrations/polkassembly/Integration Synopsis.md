# Polkassembly — Integration Synopsis

## 1. Summary
The Polkassembly integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Polkassembly infrastructure.
