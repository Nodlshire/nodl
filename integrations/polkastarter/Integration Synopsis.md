# Polkastarter — Integration Synopsis

## 1. Summary
The Polkastarter integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Polkastarter infrastructure.
