# Polygon — Integration Synopsis

## 1. Summary
The Polygon integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Polygon infrastructure.
