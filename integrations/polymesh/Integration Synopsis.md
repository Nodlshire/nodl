# Polymesh — Integration Synopsis

## 1. Summary
The Polymesh integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Polymesh infrastructure.
