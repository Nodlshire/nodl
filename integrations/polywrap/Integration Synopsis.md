# Polywrap — Integration Synopsis

## 1. Summary
The Polywrap integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Polywrap infrastructure.
