# Pontem — Integration Synopsis

## 1. Summary
The Pontem integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Pontem infrastructure.
