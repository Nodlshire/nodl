# Popcorn — Integration Synopsis

## 1. Summary
The Popcorn integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Popcorn infrastructure.
