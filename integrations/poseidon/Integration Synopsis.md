# Poseidon — Integration Synopsis

## 1. Summary
The Poseidon integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Poseidon infrastructure.
