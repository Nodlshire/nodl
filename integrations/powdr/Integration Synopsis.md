# Powdr — Integration Synopsis

## 1. Summary
The Powdr integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Powdr infrastructure.
