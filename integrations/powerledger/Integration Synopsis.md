# Powerledger — Integration Synopsis

## 1. Summary
The Powerledger integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Powerledger infrastructure.
