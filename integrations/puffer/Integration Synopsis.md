# Puffer — Integration Synopsis

## 1. Summary
The Puffer integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Puffer infrastructure.
