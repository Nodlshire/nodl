# Pushprotocol — Integration Synopsis

## 1. Summary
The Pushprotocol integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Pushprotocol infrastructure.
