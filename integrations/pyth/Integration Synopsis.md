# Pyth — Integration Synopsis

## 1. Summary
The Pyth integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Pyth infrastructure.
