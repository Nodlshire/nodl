# Qtum — Integration Synopsis

## 1. Summary
The Qtum integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Qtum infrastructure.
