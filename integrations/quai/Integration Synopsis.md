# Quai — Integration Synopsis

## 1. Summary
The Quai integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Quai infrastructure.
