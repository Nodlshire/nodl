# Quarkid — Integration Synopsis

## 1. Summary
The Quarkid integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Quarkid infrastructure.
