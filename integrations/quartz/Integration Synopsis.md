# Quartz — Integration Synopsis

## 1. Summary
The Quartz integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Quartz infrastructure.
