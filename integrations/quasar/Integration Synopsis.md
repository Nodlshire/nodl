# Quasar — Integration Synopsis

## 1. Summary
The Quasar integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Quasar infrastructure.
