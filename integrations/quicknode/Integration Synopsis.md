# Quicknode — Integration Synopsis

## 1. Summary
The Quicknode integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Quicknode infrastructure.
