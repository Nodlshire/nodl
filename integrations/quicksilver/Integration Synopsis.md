# Quicksilver — Integration Synopsis

## 1. Summary
The Quicksilver integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Quicksilver infrastructure.
