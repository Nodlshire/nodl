// Quicksilver Wnode Integration SDK
import { BaseIntegrationClient } from '../shared/base-client';

export class QuicksilverClient extends BaseIntegrationClient {
    constructor(config: any) {
        super('quicksilver', config);
    }
...
export const defaultQuicksilverConfig = {
    name: 'quicksilver',
    auth: '',
    rateLimits: ''
};
