# Quipuswap — Integration Synopsis

## 1. Summary
The Quipuswap integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Quipuswap infrastructure.
