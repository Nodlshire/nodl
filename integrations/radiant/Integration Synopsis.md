# Radiant — Integration Synopsis

## 1. Summary
The Radiant integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Radiant infrastructure.
