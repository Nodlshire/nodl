# Radix — Integration Synopsis

## 1. Summary
The Radix integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Radix infrastructure.
