# Rainbow — Integration Synopsis

## 1. Summary
The Rainbow integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Rainbow infrastructure.
