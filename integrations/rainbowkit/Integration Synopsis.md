# Rainbowkit — Integration Synopsis

## 1. Summary
The Rainbowkit integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Rainbowkit infrastructure.
