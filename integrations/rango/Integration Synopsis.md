# Rango — Integration Synopsis

## 1. Summary
The Rango integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Rango infrastructure.
