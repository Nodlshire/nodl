# Rarible — Integration Synopsis

## 1. Summary
The Rarible integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Rarible infrastructure.
