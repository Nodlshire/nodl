# Ravencoin — Integration Synopsis

## 1. Summary
The Ravencoin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Ravencoin infrastructure.
