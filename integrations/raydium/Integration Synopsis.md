# Raydium — Integration Synopsis

## 1. Summary
The Raydium integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Raydium infrastructure.
