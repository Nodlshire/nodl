# Redstone — Integration Synopsis

## 1. Summary
The Redstone integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Redstone infrastructure.
