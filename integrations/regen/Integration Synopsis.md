# Regen — Integration Synopsis

## 1. Summary
The Regen integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Regen infrastructure.
