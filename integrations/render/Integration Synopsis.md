# Render — Integration Synopsis

## 1. Summary
The Render integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Render infrastructure.
