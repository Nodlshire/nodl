# Renprotocol — Integration Synopsis

## 1. Summary
The Renprotocol integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Renprotocol infrastructure.
