# Reservoir — Integration Synopsis

## 1. Summary
The Reservoir integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Reservoir infrastructure.
