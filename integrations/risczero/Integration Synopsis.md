# Risczero — Integration Synopsis

## 1. Summary
The Risczero integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Risczero infrastructure.
