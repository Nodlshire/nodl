# Robonomics — Integration Synopsis

## 1. Summary
The Robonomics integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Robonomics infrastructure.
