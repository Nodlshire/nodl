# Rocketpool — Integration Synopsis

## 1. Summary
The Rocketpool integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Rocketpool infrastructure.
