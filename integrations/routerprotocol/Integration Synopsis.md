# Routerprotocol — Integration Synopsis

## 1. Summary
The Routerprotocol integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Routerprotocol infrastructure.
