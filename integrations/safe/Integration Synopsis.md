# Safe — Integration Synopsis

## 1. Summary
The Safe integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Safe infrastructure.
