# Scroll — Integration Synopsis

## 1. Summary
The Scroll integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Scroll infrastructure.
