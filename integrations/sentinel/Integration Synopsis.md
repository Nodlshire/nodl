# Sentinel — Integration Synopsis

## 1. Summary
The Sentinel integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Sentinel infrastructure.
