# Shadow — Integration Synopsis

## 1. Summary
The Shadow integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Shadow infrastructure.
