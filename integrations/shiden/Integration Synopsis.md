# Shiden — Integration Synopsis

## 1. Summary
The Shiden integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Shiden infrastructure.
