# Shutter — Integration Synopsis

## 1. Summary
The Shutter integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Shutter infrastructure.
