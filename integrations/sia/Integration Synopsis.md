# Sia — Integration Synopsis

## 1. Summary
The Sia integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Sia infrastructure.
