# Siacoin — Integration Synopsis

## 1. Summary
The Siacoin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Siacoin infrastructure.
