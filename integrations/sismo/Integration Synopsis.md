# Sismo — Integration Synopsis

## 1. Summary
The Sismo integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Sismo infrastructure.
