# Skale — Integration Synopsis

## 1. Summary
The Skale integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Skale infrastructure.
