# Snowtrace — Integration Synopsis

## 1. Summary
The Snowtrace integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Snowtrace infrastructure.
