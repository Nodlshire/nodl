# Sommelier — Integration Synopsis

## 1. Summary
The Sommelier integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Sommelier infrastructure.
