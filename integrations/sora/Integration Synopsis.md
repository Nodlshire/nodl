# Sora — Integration Synopsis

## 1. Summary
The Sora integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Sora infrastructure.
