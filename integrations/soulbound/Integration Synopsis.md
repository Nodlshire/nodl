# Soulbound — Integration Synopsis

## 1. Summary
The Soulbound integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Soulbound infrastructure.
