// Tests for spaceandtime
import { SpaceandtimeClient } from './sdk';

describe('Spaceandtime Integration', () => {
    let client: SpaceandtimeClient;

    beforeEach(() => {
        client = new SpaceandtimeClient({ mocked: true });
    });
