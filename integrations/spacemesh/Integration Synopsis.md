# Spacemesh — Integration Synopsis

## 1. Summary
The Spacemesh integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Spacemesh infrastructure.
