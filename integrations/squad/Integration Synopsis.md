# Squad — Integration Synopsis

## 1. Summary
The Squad integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Squad infrastructure.
