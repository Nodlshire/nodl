# Stader — Integration Synopsis

## 1. Summary
The Stader integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Stader infrastructure.
