# Stafi — Integration Synopsis

## 1. Summary
The Stafi integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Stafi infrastructure.
