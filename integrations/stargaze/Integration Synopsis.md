# Stargaze — Integration Synopsis

## 1. Summary
The Stargaze integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Stargaze infrastructure.
