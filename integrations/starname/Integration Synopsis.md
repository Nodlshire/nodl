# Starname — Integration Synopsis

## 1. Summary
The Starname integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Starname infrastructure.
