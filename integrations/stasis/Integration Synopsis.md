# Stasis — Integration Synopsis

## 1. Summary
The Stasis integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Stasis infrastructure.
