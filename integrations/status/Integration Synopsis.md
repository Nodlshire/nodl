# Status — Integration Synopsis

## 1. Summary
The Status integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Status infrastructure.
