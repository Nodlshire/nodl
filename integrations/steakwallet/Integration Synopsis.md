# Steakwallet — Integration Synopsis

## 1. Summary
The Steakwallet integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Steakwallet infrastructure.
