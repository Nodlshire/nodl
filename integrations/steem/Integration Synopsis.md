# Steem — Integration Synopsis

## 1. Summary
The Steem integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Steem infrastructure.
