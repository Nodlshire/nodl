# Stella — Integration Synopsis

## 1. Summary
The Stella integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Stella infrastructure.
