# Stratis — Integration Synopsis

## 1. Summary
The Stratis integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Stratis infrastructure.
