# Stride — Integration Synopsis

## 1. Summary
The Stride integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Stride infrastructure.
