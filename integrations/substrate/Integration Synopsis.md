# Substrate — Integration Synopsis

## 1. Summary
The Substrate integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Substrate infrastructure.
