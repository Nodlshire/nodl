# Superfluid — Integration Synopsis

## 1. Summary
The Superfluid integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Superfluid infrastructure.
