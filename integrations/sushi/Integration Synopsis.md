# Sushi — Integration Synopsis

## 1. Summary
The Sushi integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Sushi infrastructure.
