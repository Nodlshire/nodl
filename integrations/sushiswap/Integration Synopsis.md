# Sushiswap — Integration Synopsis

## 1. Summary
The Sushiswap integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Sushiswap infrastructure.
