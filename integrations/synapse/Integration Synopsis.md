# Synapse — Integration Synopsis

## 1. Summary
The Synapse integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Synapse infrastructure.
