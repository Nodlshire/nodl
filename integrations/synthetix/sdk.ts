...
optimizationEngine.register('synthetix', {
  get_opportunities: synthetix.get_opportunities,
  simulate: synthetix.simulate,
  execute: synthetix.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('synthetix', 'Perps');
