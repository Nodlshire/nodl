# Tapioca — Integration Synopsis

## 1. Summary
The Tapioca integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Tapioca infrastructure.
