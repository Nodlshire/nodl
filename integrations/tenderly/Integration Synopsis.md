# Tenderly — Integration Synopsis

## 1. Summary
The Tenderly integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Tenderly infrastructure.
