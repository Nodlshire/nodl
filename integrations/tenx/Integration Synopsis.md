# Tenx — Integration Synopsis

## 1. Summary
The Tenx integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Tenx infrastructure.
