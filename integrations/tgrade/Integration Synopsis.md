# Tgrade — Integration Synopsis

## 1. Summary
The Tgrade integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Tgrade infrastructure.
