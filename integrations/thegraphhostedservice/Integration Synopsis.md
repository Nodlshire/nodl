# Thegraphhostedservice — Integration Synopsis

## 1. Summary
The Thegraphhostedservice integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Thegraphhostedservice infrastructure.

## 2. What This Integration Does
**Core SDK Capabilities Exposed:**
- `thegraphhostedservice()`
...
```json
{
  "integration": "Thegraphhostedservice",
  "domain": "Protocol",
  "revenue_model": {
    "direct": false,
    "indirect": false,
