# Thorchain — Integration Synopsis

## 1. Summary
The Thorchain integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Thorchain infrastructure.
