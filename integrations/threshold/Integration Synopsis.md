# Threshold — Integration Synopsis

## 1. Summary
The Threshold integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Threshold infrastructure.
