# Tidefi — Integration Synopsis

## 1. Summary
The Tidefi integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Tidefi infrastructure.
