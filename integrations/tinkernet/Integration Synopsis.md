# Tinkernet — Integration Synopsis

## 1. Summary
The Tinkernet integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Tinkernet infrastructure.
