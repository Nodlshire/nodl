# Tornado — Integration Synopsis

## 1. Summary
The Tornado integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Tornado infrastructure.
