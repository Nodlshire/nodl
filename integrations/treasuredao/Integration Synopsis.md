# Treasuredao — Integration Synopsis

## 1. Summary
The Treasuredao integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Treasuredao infrastructure.
