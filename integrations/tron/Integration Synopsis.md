# Tron — Integration Synopsis

## 1. Summary
The Tron integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Tron infrastructure.
