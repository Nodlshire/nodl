# Truefi — Integration Synopsis

## 1. Summary
The Truefi integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Truefi infrastructure.
