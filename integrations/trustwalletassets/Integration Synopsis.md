# Trustwalletassets — Integration Synopsis

## 1. Summary
The Trustwalletassets integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Trustwalletassets infrastructure.
