# Turing — Integration Synopsis

## 1. Summary
The Turing integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Turing infrastructure.
