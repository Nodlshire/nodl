# Umee — Integration Synopsis

## 1. Summary
The Umee integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Umee infrastructure.
