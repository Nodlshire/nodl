# Unique — Integration Synopsis

## 1. Summary
The Unique integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Unique infrastructure.
