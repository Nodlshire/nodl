# Unlockprotocol — Integration Synopsis

## 1. Summary
The Unlockprotocol integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Unlockprotocol infrastructure.
