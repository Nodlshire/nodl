# Valist — Integration Synopsis

## 1. Summary
The Valist integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Valist infrastructure.
