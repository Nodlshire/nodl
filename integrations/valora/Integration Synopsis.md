# Valora — Integration Synopsis

## 1. Summary
The Valora integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Valora infrastructure.
