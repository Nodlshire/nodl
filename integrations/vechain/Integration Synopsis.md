# Vechain — Integration Synopsis

## 1. Summary
The Vechain integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Vechain infrastructure.
