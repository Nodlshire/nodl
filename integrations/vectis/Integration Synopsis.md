# Vectis — Integration Synopsis

## 1. Summary
The Vectis integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Vectis infrastructure.
