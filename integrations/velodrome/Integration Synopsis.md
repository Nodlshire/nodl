# Velodrome — Integration Synopsis

## 1. Summary
The Velodrome integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Velodrome infrastructure.
