...
optimizationEngine.register('velodrome', {
  get_opportunities: velodrome.get_opportunities,
  simulate: velodrome.simulate,
  execute: velodrome.execute
}, agents);

// Enable Real-Time Monitoring and Alerting
monitoringEngine.enable('velodrome', 'SpotDEX');
