# Venus — Integration Synopsis

## 1. Summary
The Venus integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Venus infrastructure.
