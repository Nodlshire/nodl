# Vertcoin — Integration Synopsis

## 1. Summary
The Vertcoin integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Vertcoin infrastructure.
