# Vidulum — Integration Synopsis

## 1. Summary
The Vidulum integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Vidulum infrastructure.
