# Vital — Integration Synopsis

## 1. Summary
The Vital integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Vital infrastructure.
