# Walletconnect — Integration Synopsis

## 1. Summary
The Walletconnect integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Walletconnect infrastructure.
