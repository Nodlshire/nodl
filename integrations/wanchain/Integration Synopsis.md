# Wanchain — Integration Synopsis

## 1. Summary
The Wanchain integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Wanchain infrastructure.
