# Waves — Integration Synopsis

## 1. Summary
The Waves integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Waves infrastructure.
