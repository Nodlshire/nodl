# Web3Auth — Integration Synopsis

## 1. Summary
The Web3Auth integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Web3Auth infrastructure.
