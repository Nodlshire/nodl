# Wemix — Integration Synopsis

## 1. Summary
The Wemix integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Wemix infrastructure.
