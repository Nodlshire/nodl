# Witnesschain — Integration Synopsis

## 1. Summary
The Witnesschain integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Witnesschain infrastructure.
