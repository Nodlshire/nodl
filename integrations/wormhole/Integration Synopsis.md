# Wormhole — Integration Synopsis

## 1. Summary
The Wormhole integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Wormhole infrastructure.
