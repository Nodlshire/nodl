# Xrp — Integration Synopsis

## 1. Summary
The Xrp integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Xrp infrastructure.
