# Yearn — Integration Synopsis

## 1. Summary
The Yearn integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Yearn infrastructure.
