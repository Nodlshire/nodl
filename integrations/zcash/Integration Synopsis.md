# Zcash — Integration Synopsis

## 1. Summary
The Zcash integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Zcash infrastructure.
