# Zilliqa — Integration Synopsis

## 1. Summary
The Zilliqa integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Zilliqa infrastructure.
