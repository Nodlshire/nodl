# Zkapps — Integration Synopsis

## 1. Summary
The Zkapps integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Zkapps infrastructure.
