# Zkbob — Integration Synopsis

## 1. Summary
The Zkbob integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Zkbob infrastructure.
