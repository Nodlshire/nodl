# Zklink — Integration Synopsis

## 1. Summary
The Zklink integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Zklink infrastructure.
