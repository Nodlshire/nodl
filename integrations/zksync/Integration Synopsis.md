# Zksync — Integration Synopsis

## 1. Summary
The Zksync integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Zksync infrastructure.
