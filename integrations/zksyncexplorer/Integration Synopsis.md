# Zksyncexplorer — Integration Synopsis

## 1. Summary
The Zksyncexplorer integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Zksyncexplorer infrastructure.
