# Zora — Integration Synopsis

## 1. Summary
The Zora integration operates in the `Protocol` domain. 

This integration allows Wnode autonomous agents to interact securely with Zora infrastructure.
