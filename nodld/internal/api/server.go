...
func (s *Server) registerRoutes() {
	...
	s.app.Post("/api/v1/nodes/headless-token/consume", s.handleConsumeHeadlessToken)
	s.app.Post("/api/nodes/headless-token/consume", s.handleConsumeHeadlessToken)
	apiV1.Get("/cmd/node/epoch", s.handleGetEpoch)
	apiV1.Get("/nodes/epoch", s.handleGetEpoch)
	apiV1.Get("/epoch", s.handleGetEpoch)
	s.app.Get("/api/cmd/node/epoch", s.handleGetEpoch)
	s.app.Get("/api/v1/cmd/node/epoch", s.handleGetEpoch)
	s.app.Get("/api/v1/nodes/epoch", s.handleGetEpoch)
	s.app.Get("/api/nodes/epoch", s.handleGetEpoch)
	s.app.Get("/api/epoch", s.handleGetEpoch)
