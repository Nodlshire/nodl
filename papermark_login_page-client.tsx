...
export default function Login() {
  ...
  return (
    <div className="flex h-screen w-full flex-wrap bg-black">
      {/* Left part */}
      <div className="flex w-full justify-center bg-black md:w-1/2 lg:w-2/5">
        <div
          className="absolute inset-x-0 top-10 -z-10 flex transform-gpu justify-center overflow-hidden blur-3xl"
          aria-hidden="true"
        ></div>
        <div className="z-10 mx-5 mt-[calc(20vh)] h-fit w-full max-w-md overflow-hidden rounded-lg sm:mx-0 bg-[#111111] border border-white/10 shadow-2xl">
          <div className="flex flex-col items-center justify-center space-y-3 px-4 py-6 pt-8 text-center sm:px-16">
            <Link href="/">
              <img src="/wnode-logo.svg" alt="Wnode Logo" className="h-10 w-auto mb-4" />
            </Link>
            <h1 className="text-balance text-2xl font-semibold text-white">
              Wnode Data Room
            </h1>
            <h3 className="text-balance text-sm text-gray-400">
              Securely access planetary compute infrastructure documents.
            </h3>
          </div>
          <form
          ...
          >
            ...
            <Input
              ...
              className={cn(
                "flex h-10 w-full rounded-md border-0 bg-black px-3 py-2 text-sm text-white ring-1 ring-gray-800 transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50",
          ...
          <p className="py-4 text-center text-gray-500">or</p>
          <div className="flex flex-col space-y-2 px-4 sm:px-16 pb-8">
            <div className="relative">
              <Button
                onClick={() => {
