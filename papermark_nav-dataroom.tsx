...
export function asDataroomViewerHeaderStyle(style: string | undefined | null): DataroomViewerHeaderStyle {
  if (style === "SPLIT" || style === "NOTION") return style as DataroomViewerHeaderStyle;
  return "DEFAULT";
}

import { cn, formatDate } from "@/lib/utils";
// Stub out missing EE imports
